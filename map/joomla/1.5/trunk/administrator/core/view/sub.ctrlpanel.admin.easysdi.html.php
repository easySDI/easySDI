							...
							<tr>
								...
								<td class="header_sdi_list">
									<ul>
										...
										<li><?php printf('<a href="index.php?option=%s&amp;task=editResource&filename='.JPATH_COMPONENT_SITE.DS.'resource'.DS.'xslt'.DS.'getFeatureInfo.xslt'.'">', 'com_easysdi_map'); echo JText::_( 'CORE_CPANEL_MAP_RESOURCE_XSL_LABEL' ); ?></a></li>
										<li><?php printf('<a href="index.php?option=%s&amp;task=editResource&filename='.JPATH_COMPONENT_SITE.DS.'resource'.DS.'xslt'.DS.'getFeatureInfo.css'.'">', 'com_easysdi_map'); echo JText::_( 'CORE_CPANEL_MAP_RESOURCE_CSS_LABEL' ); ?></a></li>
									</ul>
								</td>
								<td class="header_sdi_list">
									<ul >
