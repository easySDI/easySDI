...
class HTML_overlay 
{
	...
	function submitbutton(pressbutton)
	{
		if(pressbutton == "saveOverlayContent")
		{
			...
			{
				alert ('<?php echo  JText::_( 'EASYSDI_OVL_CT_MIN_RES_VALIDATION_ERROR');?>');	
				return;
			}
			else if (document.getElementById('maxResolution').value == "")
			{
				alert ('<?php echo  JText::_( 'EASYSDI_OVL_CT_MAX_RES_VALIDATION_ERROR');?>');	
				return;
			}
					...
					<fieldset>
						<table class="admintable">
							...
							<tr>
								...
								<td>
								<?php echo JHTML::_("select.genericlist",$rowsGroup, 'overlay_group_id', 'size="1" class="inputbox" ', 'value', 'text',$overlay_content->overlay_group_id); ?>															
							</tr>
							<tr>
								<td class="key"><?php echo JText::_("EASYSDI_OVERLAY_PROJECTION"); ?></td>
								<td><input class="inputbox" type="text" size="50" maxlength="100" name="projection" id="projection" value="<?php echo $overlay_content->projection; ?>" /></td>
							</tr>
							...
							<tr>							
								<td class="key"><?php echo JText::_("EASYSDI_OVERLAY_MINRESOLUTION"); ?></td>
								<td><input class="inputbox" type="text" size="50" maxlength="100" name="minResolution" id="minResolution" value="<?php echo $overlay_content->minResolution; ?>" /></td>							
							</tr>
							<tr>							
								<td class="key"><?php echo JText::_("EASYSDI_OVERLAY_MAXRESOLUTION"); ?></td>
								<td><input class="inputbox" type="text" size="50" maxlength="100" name="maxResolution" id="maxResolution" value="<?php echo $overlay_content->maxResolution; ?>" /></td>							
							</tr>
							<tr>
								<td class="key"><?php echo JText::_("EASYSDI_OVERLAY_MAXEXTENT"); ?></td>
								<td><input class="inputbox" type="text" size="50" maxlength="100" name="maxExtent" id="maxExtent" value="<?php echo $overlay_content->maxExtent; ?>" /></td>							
							</tr>
							<tr>
							...
							<tr>							
								...
								<option <?php if($overlay_content->singletile == 0) echo "selected" ; ?> value="0"> <?php echo JText::_("EASYSDI_NO"); ?></option>
								<option <?php if($overlay_content->singletile == 1) echo "selected" ; ?> value="1"> <?php echo JText::_("EASYSDI_YES"); ?></option>
								</select>
								</td>
							</tr>
							<tr>
								...
								<td>
									<input class="inputbox"  name="img_format" id="img_format" type="text" size="50" maxlength="100" value="<?php echo $overlay_content->img_format; ?>" />									
								</td>
								<td>ex : image/png</td>															
							</tr>
							<tr>
							...
							<tr>							
								...
								<td><input class="inputbox" type="text" size="50" maxlength="100" name="name" id="name" value="<?php echo stripcslashes($overlay_content->name); ?>" /></td>							
							</tr>
							<tr>							
								<td class="key"><?php echo JText::_("EASYSDI_OVERLAY_VISIBILITY"); ?></td>
								<td><select class="inputbox" name="default_visibility" >								
								<option <?php if($overlay_content->default_visibility == 0) echo "selected" ; ?> value="0"> <?php echo JText::_("EASYSDI_NO"); ?></option>
								<option <?php if($overlay_content->default_visibility == 1) echo "selected" ; ?> value="1"> <?php echo JText::_("EASYSDI_YES"); ?></option>
								</select>
								</td>
							</tr>	
							<tr>							
								<td class="key"><?php echo JText::_("EASYSDI_OVERLAY_OPACITY"); ?></td>
								<td><input class="inputbox" type="text" size="50" maxlength="100" name="default_opacity" id="default_opacity" value="<?php echo $overlay_content->default_opacity; ?>" /></td>							
							</tr>	
							<tr>							
								<td class="key"><?php echo JText::_("EASYSDI_OVERLAY_METADATA"); ?></td>
								<td><input class="inputbox" type="text" size="50" maxlength="500" name="metadata_url" id="metadata_url" value="<?php echo $overlay_content->metadata_url; ?>" /></td>							
							</tr>			
						</table>
					</fieldset>
				</td>
		...
		<input type="hidden" name="order" value="<?php echo $overlay_content->order;?>">
