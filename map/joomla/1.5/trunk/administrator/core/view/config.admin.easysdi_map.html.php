...
class HTML_config 
{
	function listMapConfig($use_pagination, $rows, $pageNav, $option)
	{
		...
		?>
	  	...
	  	<input type="hidden" name="task" value="mapConfig" />
	...
	<form action="index.php" method="post" name="adminForm" id="adminForm" class="adminForm">
					...
					<fieldset>						
						<table class="admintable">
							...
							<tr>
								...
								<td><input class="inputbox" type="text" size="100" maxlength="250" name="description" id="description" value="<?php echo $mapconfig->description; ?>" /></td>
							</tr>
							<tr>
		...
		<input type="hidden" name="id" value="<?php echo $mapconfig->id; ?>" />
		<input type="hidden" name="option" value="<?php echo $option; ?>" />
