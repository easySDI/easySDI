		...
		if ($type != '') {
			...
			switch ($type) {
				case '1':	// Bulletin de vote pour AG
					$query = "SELECT COUNT(*)";
					$query .= " FROM #__users,#__easysdi_community_partner";
					$query .= " WHERE #__users.id=#__easysdi_community_partner.user_id";
					$query .= " AND #__easysdi_community_partner.root_id IS NULL";
					$query .= " AND #__easysdi_community_partner.profile_id IN (2,3)";
					break;
				...
				case '3':	// Facturation utilisateurs
					...
					$query .= " WHERE #__users.id=#__easysdi_community_partner.user_id";
					$query .= " AND #__easysdi_community_partner.root_id IS NULL";
					$query .= " AND #__easysdi_community_partner.profile_id IN (4)";
					break;
				default:
					break;
			...
			switch ($type) {
				case '1':	// Bulletin de vote pour AG
					$query = "SELECT #__users.name as partner_name,#__users.username as partner_username,#__easysdi_community_partner.*";
					$query .= " FROM #__users,#__easysdi_community_partner";
					$query .= " WHERE #__users.id=#__easysdi_community_partner.user_id";
					$query .= " AND #__easysdi_community_partner.root_id IS NULL";
					$query .= " AND #__easysdi_community_partner.profile_id IN (2,3)";
