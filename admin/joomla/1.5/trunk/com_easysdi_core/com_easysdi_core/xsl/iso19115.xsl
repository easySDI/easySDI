...
<xsl:choose>
          <xsl:when test="./gmd:identificationInfo/gmd:MD_DataIdentification/gmd:resourceMaintenance/gmd:MD_MaintenanceInformation/gmd:maintenanceAndUpdateFrequency/gmd:MD_MaintenanceFrequencyCode[@codeList='http://www.isotc211.org/2005/resources/codeList.xml#MD_MaintenanceFrequencyCode']/@codeListValue = 'continual'">
            Continu
          </xsl:when>
          <xsl:otherwise>
            Autre : <xsl:value-of disable-output-escaping="yes" select="./gmd:identificationInfo/gmd:MD_DataIdentification/gmd:resourceMaintenance/gmd:MD_MaintenanceInformation/gmd:maintenanceAndUpdateFrequency/gmd:MD_MaintenanceFrequencyCode[@codeList='http://www.isotc211.org/2005/resources/codeList.xml#MD_MaintenanceFrequencyCode']/@codeListValue "/>
</xsl:otherwise>
</xsl:choose>
</td></tr>
...
<tr><td>Echelle de référence:</td><td>
</td></tr>
<tr><td>Précision:</td><td>
