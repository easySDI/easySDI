 ...
 * @see Schema
 * @source $URL: http://svn.geotools.org/geotools/tags/2.4.1/modules/library/xml/src/main/java/org/geotools/xml/handlers/ElementHandlerFactory.java $
 */
public class ElementHandlerFactory {
     ...
     *      java.lang.String)
     */
    public void startPrefixMapping(String prefix, String targ, URI uri,String user,String password)
        throws SAXException {
        ...
        try {
            ...
            Schema s = SchemaFactory.getInstance(tns, uri, logger.getLevel(),user,password);
