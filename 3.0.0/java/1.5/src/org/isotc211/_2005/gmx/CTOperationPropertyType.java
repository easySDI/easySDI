...
import net.opengis.gml.v320.AbstractCoordinateOperationType;
import net.opengis.gml.v320.AbstractGeneralConversionType;
import net.opengis.gml.v320.AbstractGeneralTransformationType;
import net.opengis.gml.v320.ConcatenatedOperationType;
import net.opengis.gml.v320.Conversion2;
import net.opengis.gml.v320.PassThroughOperationType;
import net.opengis.gml.v320.TransformationType;


/**
 * <p>Java class for CT_Operation_PropertyType complex type.
 * 
...
@XmlType(name = "CT_Operation_PropertyType", propOrder = {
    "abstractCoordinateOperation"
})
public class CTOperationPropertyType {

    @XmlElementRef(name = "AbstractCoordinateOperation", namespace = "http://www.opengis.net/gml", type = JAXBElement.class)
