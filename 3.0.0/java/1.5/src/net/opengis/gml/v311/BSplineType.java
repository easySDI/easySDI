 ...
 *       &lt;attribute name="isPolynomial" type="{http://www.opengis.net/gml}booleanOrNull" />
    ...
    extends AbstractCurveSegmentType
{
    ...
    @XmlAttribute
    protected List<String> isPolynomial;
    @XmlAttribute
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the isPolynomial property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getIsPolynomial().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<String> getIsPolynomial() {
        if (isPolynomial == null) {
            isPolynomial = new ArrayList<String>();
        }
