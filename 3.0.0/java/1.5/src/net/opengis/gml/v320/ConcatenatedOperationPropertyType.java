...
public class ConcatenatedOperationPropertyType {
    ...
    @XmlElementRef(name = "ConcatenatedOperation", namespace = "http://www.opengis.net/gml", type = JAXBElement.class)
    protected JAXBElement<? extends ConcatenatedOperationType> concatenatedOperation;
    @XmlAttribute
     ...
     *     
     */
    public JAXBElement<? extends ConcatenatedOperationType> getConcatenatedOperation() {
     ...
     *     
     */
    public void setConcatenatedOperation(JAXBElement<? extends ConcatenatedOperationType> value) {
        this.concatenatedOperation = ((JAXBElement<? extends ConcatenatedOperationType> ) value);
    }
