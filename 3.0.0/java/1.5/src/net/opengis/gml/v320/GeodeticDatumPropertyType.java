...
public class GeodeticDatumPropertyType {
    ...
    @XmlElementRef(name = "GeodeticDatum", namespace = "http://www.opengis.net/gml", type = GeodeticDatum2 .class)
    protected JAXBElement<? extends GeodeticDatumType> geodeticDatum;
    @XmlAttribute
     ...
     *     
     */
    public JAXBElement<? extends GeodeticDatumType> getGeodeticDatum() {
     ...
     *     
     */
    public void setGeodeticDatum(JAXBElement<? extends GeodeticDatumType> value) {
        this.geodeticDatum = ((JAXBElement<? extends GeodeticDatumType> ) value);
    }
