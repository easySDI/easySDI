...
public class ValueArrayPropertyType {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "AbstractValue", namespace = "http://www.opengis.net/gml", type = JAXBElement.class),
        ...
        @XmlElementRef(name = "AbstractTimeObject", namespace = "http://www.opengis.net/gml", type = JAXBElement.class)
    })
