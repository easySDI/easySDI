 ...
 * @source $URL: http://svn.geotools.org/geotools/tags/2.4.1/modules/library/xml/src/main/java/org/geotools/xml/SchemaFactory.java $
...
public class SchemaFactory {
     ...
     */
    public synchronized static Schema getInstance(URI targetNamespace,
	    URI desiredSchema, Level level,String user,String password) throws SAXException {
