...
public class Config {
     ...
     * @param logFile
     */    
    public Config(String id, List<RemoteServerInfo> remoteServer, String policyFile,
	     String logFile) {
	super();
	this.id = id;
	...
	if (logDateFormat == null) logDateFormat = DEFAULT_DATE_FORMAT;
	else if (logDateFormat.length()==0) logDateFormat = DEFAULT_DATE_FORMAT;
	else this.logDateFormat = logDateFormat;	
    }
