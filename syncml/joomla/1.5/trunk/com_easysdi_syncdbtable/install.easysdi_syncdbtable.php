...
function com_install(){
	...
	$query =  "insert into #__components (parent,name,link,admin_menu_link,admin_menu_alt,`option`,admin_menu_img,params)
		values($id,'SyncDbTable','','option=com_easysdi_syncdbtable&task=showConfigList','SyncDbTable','com_easysdi_syncdbtable','js/ThemeOffice/component.png','')";
	$db->setQuery( $query);
	...
	$query =  "insert into #__components (parent,name,link,admin_menu_link,admin_menu_alt,`option`,admin_menu_img,params)
		values($id,'SyncDbTable Config','','option=com_easysdi_syncdbtable&task=componentConfig','SyncDbTable Config','com_easysdi_syncdbtable','js/ThemeOffice/component.png','')";
	$db->setQuery( $query);
