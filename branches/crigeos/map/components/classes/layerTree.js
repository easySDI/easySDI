...
WMSoptions.CACHE=true;var l=new OpenLayers.Layer.WMS(layer.name,layer.url,WMSoptions,extraOptions);if(layer.cache)
...
l.setVisibility(false);this._layerStore.map.addLayer(l);var mstyle='';var toolTip='';var metadataUrl='';var target='';if(layer.metadataUrl.length>0){mstyle='metadataAvailable';metadataUrl=layer.metadataUrl;target='_blank';}
