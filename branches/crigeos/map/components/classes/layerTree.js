...
this._layerStore.map.events.register("moveend",this,this.onMoveEnd);this._loadMask=this._layerStore.map.loadingPanel;this._loadMask.activate();},onPreAddLayer:function(evt){if(evt.layer.visibility){this._loadMask.maximizeControl();this.loadEvents.push(evt.type);}
else{this.onMoveEnd(evt)}},onMoveStarted:function(evt){this.loadEvents.push(evt.type);this._loadMask.maximizeControl();},onMoveEnd:function(evt){a=this.loadEvents.pop();console.log(this.loadEvents);if(this.loadEvents.length==0)
...
this._layerStore.map.addLayer(l);l.events.register("loadstart",this,this.onMoveStarted);l.events.register('loadend',this,this.onMoveEnd);l.events.register('visibilitychanged',this,this.onMoveEnd);if(layer.defaultVisibility)
