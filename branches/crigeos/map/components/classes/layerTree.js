...
else{this.onMoveEnd(evt)}},onMoveStarted:function(evt){this.loadEvents.push(evt.type);this._loadMask.maximizeControl();},onMoveEnd:function(evt){a=this.loadEvents.pop();if(this.loadEvents.length==0)
