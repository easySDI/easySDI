...
(function() {
     ...
     *             // The following two files / format.js and control.js need to be added at this stage explicity to ensure that we meet 
            // depencies for our project.
            // This needs to be carried forward in future migrations until management decides to drop it.
              // we will use the XMLHttpRequest from version 2.8 of openlayers. 
            // This needs to be carried forward in future migrations until management decides to drop it.
      */
    if(!singleFile) {
