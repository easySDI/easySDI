...
class TOOLBAR_attribute {
	function _DEFAULT() {
		JToolBarHelper::title(JText::_("CATALOG_LIST_ATTRIBUTE"));
	...
	function _EDIT() {
		...
		JToolBarHelper::title(JText::_( 'CATALOG_EDIT_ATTRIBUTE' ).': <small><small>[ '. $text.' ]</small></small>', 'addedit.png');
		
		JToolBarHelper::save('saveAttribute');
		JToolBarHelper::apply('applyAttribute');
		JToolBarHelper::spacer();
		JToolBarHelper::custom( 'cancelAttribute', 'back.png', 'back.png', JTEXT::_("CORE_MENU_BACK"), false );
	}
}
?>