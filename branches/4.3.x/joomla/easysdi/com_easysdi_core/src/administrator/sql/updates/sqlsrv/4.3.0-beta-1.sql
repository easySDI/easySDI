...
ALTER TABLE ONLY [#__sdi_category] ADD [overall_fee] decimal(6,2) default 0;

ALTER TABLE ONLY [#__sdi_organism] ADD [internal_free] smallint default 0;
ALTER TABLE ONLY [#__sdi_organism] ADD [fixed_fee_ti] decimal(6,2) default 0;
ALTER TABLE ONLY [#__sdi_organism] ADD [data_free_fixed_fee] smallint default 0;
ALTER TABLE ONLY [#__sdi_organism] ADD [selectable_as_thirdparty] smallint default 0;
...
INSERT [#__sdi_sys_pricing] ([id], [ordering], [state], [value]) VALUES ('2', '2', '1', N'fee without a pricing profile');
...
ALTER TABLE ONLY [#__sdi_diffusion] ADD [pricing_profile_id] [integer](11);
...
CREATE TABLE [#__sdi_pricing_order_supplier](
    ...
    [checked_out] [int] NOT NULL,
    [checked_out_time] [datetime2](0) NOT NULL,
    [pricing_order_id] [integer](11) NOT NULL,
    [supplier_id] [integer](11) NOT NULL,
...
CREATE TABLE [#__sdi_pricing_order_supplier_product](
    ...
    [checked_out] [int] NOT NULL,
    [checked_out_time] [datetime2](0) NOT NULL,
    [pricing_order_supplier_id] [integer](11) not null,
    [product_id] [integer](11) not null,
    [pricing_id] [integer](11) not null,
...
CREATE TABLE [#__sdi_pricing_order_supplier_product_profile](
    ...
    [checked_out] [int] NOT NULL,
    [checked_out_time] [datetime2](0) NOT NULL,
    [pricing_order_supplier_product_id] [integer](11)  not null,
    [pricing_profile_id] [integer](11)  not null,
