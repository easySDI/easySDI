...
slider.changeIndoorLevel(slider,slider.levels.indexOf(level));})},redrawLayer:function(layer){var level=this.getLevel();if(layer.isindoor&&layer.isindoor==1&&layer.levelfield){var servertype=layer.servertype;if(servertype==1||servertype==3){layer.mergeNewParams({'CQL_FILTER':"\""+layer.levelfield+"="+level.code+"\""});}
