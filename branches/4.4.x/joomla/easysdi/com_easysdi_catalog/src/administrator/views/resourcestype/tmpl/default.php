...
$document->addStyleSheet('components/com_easysdi_catalog/assets/css/easysdi_core.css?v=' . sdiFactory::getSdiFullVersion());
...
if ($saveOrder) {
    $saveOrderingUrl = 'index.php?option=com_easysdi_catalog&task=resourcestype.saveOrderAjax&tmpl=component';
    JHtml::_('sortablelist.sortable', 'resourcetypeList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
...
<form action="<?php echo JRoute::_('index.php?option=com_easysdi_catalog&view=resourcestype'); ?>" method="post" name="adminForm" id="adminForm">
    <?php if (!empty($this->sidebar)): ?>
        ...
        this.form.submit();"><i class="icon-remove"></i></button>
            ...
            <table class="table table-striped" id="resourcetypeList">
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    foreach ($this->items as $i => $item) :
                        ...
                        <tr class="row<?php echo $i % 2; ?>">
                            ...
                            <?php if (isset($this->items[0]->state)): ?>
                                <td class="center">
                                    <?php echo JHtml::_('jgrid.published', $item->state, $i, 'resourcestype.', $canChange, 'cb'); ?>
                                </td>
                            <?php endif; ?>
                            ...
                            <td>
                                <?php if (($canEdit || $canEditOwn) && $canCheckin) : ?>
                                    <a href="<?php echo JRoute::_('index.php?option=com_easysdi_catalog&task=resourcetype.edit&id=' . (int) $item->id); ?>">
