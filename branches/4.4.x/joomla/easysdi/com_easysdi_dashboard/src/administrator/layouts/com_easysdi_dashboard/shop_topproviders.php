 ...
 */
$indicator_name = 'shop_topproviders';
?>
...
<div id="<?php echo('div_' . $indicator_name); ?>">
    ...
    <div class="module-title nav-header">
        <i class="icon-cog" style="text-transform: none;"></i> <?php echo JText::_('COM_EASYSDI_DASHBOARD_SHOP_IND_TOPPROVIDERS_TITLE'); ?>
        ...
        jQuery.ajax({
            ...
            success: function (json) {
                if (json.data.length > 0) {
                    ...
                    jQuery('<?php echo('#div_' . $indicator_name . ' .title-total'); ?>').text(' ( <?php echo JText::_('COM_EASYSDI_DASHBOARD_SHOP_IND_TOPPROVIDERS_TITLE_TOTAL'); ?>' + json.total + ' )');
                } else {
