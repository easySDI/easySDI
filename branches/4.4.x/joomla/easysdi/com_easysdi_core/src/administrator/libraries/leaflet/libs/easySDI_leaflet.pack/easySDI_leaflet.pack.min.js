...
return false;};_this.getFeatureUrl=function(layer,map,loc){if(!isset(layer))return false;if(layer.data.serviceconnector!='WMS'&&layer.data.serviceconnector!='WMTS')return false;var cap=_this.getCapabilities(layer.data.servicealias,layer);if(!isset(cap)||typeof cap!=='object')return null;return _getFeatureUrl(cap,layer,map,loc);};return _this;};easySDImap=function(obj,data,options){var params={};jQuery.extend(params,options);var _easySDImap={};var map;var baseLayers={};var overlays={};var services={};var mapOptions={zoomControl:false,attributionControl:false,dragging:false,touchZoom:false,doubleClickZoom:false,scrollWheelZoom:false,boxZoom:false,keyboard:false,};var container;if(options.mapoptions==undefined){options.mapoptions={};}
