 ...
 */
class Easysdi_coreControllerVersionForm extends Easysdi_coreController
{
	...
	public function edit()
	{
		...
		// Get the model.
		$model = $this->getModel('VersionForm', 'Easysdi_coreModel');
	...
	public function save()
	{
		...
		if ($data === false) {
			...
			$this->setRedirect(JRoute::_('index.php?option=com_easysdi_core&view=versionform&layout=edit&id='.$id, false));
			return false;
		}
