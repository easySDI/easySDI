...
<?php if ($this->params->get('show_page_title', 1)) : ?>
	<h2 class="componentheading<?php echo $this->params->get('pageclass_sfx')?>" style="<?php echo $direction; ?><?php echo $align; ?>"><?php echo $this->escape($this->params->get('page_title')); ?></h2>
<?php endif; ?>
<table class="contentpane<?php echo $this->params->get( 'pageclass_sfx' ); ?> w100">
<tr>
	<td><h2 class="componentheading<?php echo $this->params->get( 'pageclass_sfx' ); ?>" style="<?php echo $direction; ?><?php echo $align; ?>">
		<a href="<?php echo $this->newsfeed->channel['link']; ?>" onclick="window.open(this.href); return false;">
	...
	<td>
		...
		<?php foreach ( $this->newsfeed->items as $item ) :  ?>
			...
			<?php if ( !is_null( $item->get_link() ) ) : ?>
				<a href="<?php echo $item->get_link(); ?>" onclick="window.open(this.href); return false;">
