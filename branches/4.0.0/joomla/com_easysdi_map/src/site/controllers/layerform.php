 ...
 */
class Easysdi_mapControllerLayerForm extends Easysdi_mapController
{
	...
	public function edit()
	{
		...
		$previousId = (int) $app->getUserState('com_easysdi_map.edit.layer.id');
		$editId	= JFactory::getApplication()->input->getInt('id', null, 'array');

		// Set the user id for the user to edit in the session.
		$app->setUserState('com_easysdi_map.edit.layer.id', $editId);

		// Get the model.
		$model = $this->getModel('LayerForm', 'Easysdi_mapModel');
