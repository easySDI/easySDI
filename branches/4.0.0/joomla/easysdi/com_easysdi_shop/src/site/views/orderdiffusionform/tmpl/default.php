...
<script type="text/javascript">
    ...
    getScript('//ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js',function() {
        ...
        js(document).ready(function(){
            js('#form-orderdiffusion').submit(function(event){
...
<div class="orderdiffusion-edit front-end-edit">
    ...
    <form id="form-orderdiffusion" action="<?php echo JRoute::_('index.php?option=com_easysdi_shop&task=orderdiffusion.save'); ?>" method="post" class="form-validate" enctype="multipart/form-data">
        <ul>
        ...
        <div>
            ...
            <?php echo JText::_('or'); ?>
            <a href="<?php echo JRoute::_('index.php?option=com_easysdi_shop&task=orderdiffusion.cancel'); ?>" title="<?php echo JText::_('JCANCEL'); ?>"><?php echo JText::_('JCANCEL'); ?></a>

            <input type="hidden" name="option" value="com_easysdi_shop" />
            <input type="hidden" name="task" value="orderdiffusionform.save" />
