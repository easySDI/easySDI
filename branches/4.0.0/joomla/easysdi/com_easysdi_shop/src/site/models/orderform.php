 ...
 * Easysdi_shop model.
 */
class Easysdi_shopModelOrderForm extends JModelForm
{
	...
	public function &getData($id = null)
	{
		if ($this->_item === null)
		{
			...
			if ($table->load($id))
			{
                ...
                $id = $table->id;
                if($id){
	$canEdit = $user->authorise('core.edit', 'com_easysdi_shop.order.'.$id) || $user->authorise('core.create', 'com_easysdi_shop.order.'.$id);
}
else{
	$canEdit = $user->authorise('core.edit', 'com_easysdi_shop') || $user->authorise('core.create', 'com_easysdi_shop');
}
                if (!$canEdit && $user->authorise('core.edit.own', 'com_easysdi_shop.order.'.$id)) {
	...
	{
		// Get the form.
		$form = $this->loadForm('com_easysdi_shop.order', 'orderform', array('control' => 'jform', 'load_data' => $loadData));
		if (empty($form)) {
			return false;
		}
