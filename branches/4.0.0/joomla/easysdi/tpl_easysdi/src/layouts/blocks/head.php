...
//Add EasySDI map Stylesheets
if(JRequest::getCmd('view',null) == 'map'){
	$this->API->addCSS(JURI::base().'administrator/components/com_easysdi_core/libraries/ext/resources/css/ext-all.css');
	$this->API->addCSS(JURI::base().'administrator/components/com_easysdi_core/libraries/ext/resources/css/xtheme-gray.css');
	$this->API->addCSS(JURI::base().'administrator/components/com_easysdi_core/libraries/openlayers/theme/default/style.css');
	$this->API->addCSS(JURI::base().'administrator/components/com_easysdi_core/libraries/geoext/resources/css/popup.css');
	$this->API->addCSS(JURI::base().'administrator/components/com_easysdi_core/libraries/geoext/resources/css/layerlegend.css');
	$this->API->addCSS(JURI::base().'administrator/components/com_easysdi_core/libraries/geoext/resources/css/gxtheme-gray.css');
	$this->API->addCSS(JURI::base().'administrator/components/com_easysdi_core/libraries/ux/geoext/resources/css/printpreview.css');
	$this->API->addCSS(JURI::base().'administrator/components/com_easysdi_core/libraries/gxp/theme/all.css');
	$this->API->addCSS($this->API->URLtemplate().'/css/easysdi.css');
}
