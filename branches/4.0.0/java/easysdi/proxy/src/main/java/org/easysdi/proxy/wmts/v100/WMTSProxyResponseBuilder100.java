...
public class WMTSProxyResponseBuilder100 extends WMTSProxyResponseBuilder {
    ...
    public Boolean CapabilitiesOperationsFiltering(String filePath, String href, String version) {
        ...
        try {
            ...
            while (iOperation.hasNext()) {
                Element child = (Element) iOperation.next();
            ...
            //Remove denied operations outside the previous while loop to avoid problem with concurent access to element
    ...
    /**
     * Filter the contents of the capabilities : - allowed layers
     */
    @SuppressWarnings({"unchecked", "rawtypes"})
