...
/**
 * The outcome of an e-mail notification task.
 *
 * @author Yves Grasset
 */
public class EmailResult implements ITaskProcessorResult {

    /**
     * The string that identifies the type of error that prevented the e-mail notification task
     * from completing, if any.
     */
    private String errorCode;

    /**
     * Additional information about the type of error that prevented the e-mail notification task
     * from completing, if any.
     */
    private String message;

    /**
     * The final state of the e-mail notification task.
     */
    ...
    /**
     * Defines the type of error that prevented this e-mail notification task from completing successfully.
     *
    ...
    /**
     * Defines additional information about the error that prevented this e-mail notification task
    ...
    /**
     * Defines the final state of the notification e-mail task.
     *
    ...
    /**
     * Defines the data item request that required this e-mail notification task as part of its process.
     * <p>
     * <i>Note that some of its properties may have been updated by the task plugin.</i>
     * </p>
     *
     * @param requestToProcess the request that needs sending e-mail notifications
     */
