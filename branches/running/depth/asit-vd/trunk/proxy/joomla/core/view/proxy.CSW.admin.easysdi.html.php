	...
	<form name='adminForm' id='adminForm' action='index.php' method='POST'>
		...
		<?php
			...
			if (strcmp($config['id'],$configId)==0){
				...
				HTML_proxy::genericServletInformationsHeader ($config, $configId, "org.easysdi.proxy.csw.CSWProxyServlet", $availableServletList,$availableVersion,$servletVersion,JRequest::getVar('serviceType'))
		?>
