...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_easysdi_service&task=virtualservices.saveOrderAjax&tmpl=component';
	...
	<div class="clearfix"> </div>
		<table class="table table-striped" id="organismList">
			<thead>
				...
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_EASYSDI_SERVICE_VIRTUALSERVICE_NAME', 'a.name', $listDirn, $listOrder); ?>
			</th>
			<th class='left'>
			...
			<tr class="row<?php echo $i % 2; ?>">
				...
				<div class="pull-left">
					<?php
						...
						JHtml::_('dropdown.edit', $item->id, 'virtualservice.');
						JHtml::_('dropdown.divider');
						if ($item->state) :
							JHtml::_('dropdown.unpublish', 'cb' . $i, 'virtualservices.');
						else :
							JHtml::_('dropdown.publish', 'cb' . $i, 'virtualservices.');
						endif;
						JHtml::_('dropdown.divider');

						if ($archived) :
							JHtml::_('dropdown.unarchive', 'cb' . $i, 'virtualservices.');
						else :
							JHtml::_('dropdown.archive', 'cb' . $i, 'virtualservices.');
						endif;

						if ($item->checked_out) :
							JHtml::_('dropdown.checkin', 'cb' . $i, 'virtualservices.');
						endif;

						if ($trashed) :
							JHtml::_('dropdown.untrash', 'cb' . $i, 'virtualservices.');
						else :
							JHtml::_('dropdown.trash', 'cb' . $i, 'virtualservices.');
						endif;
