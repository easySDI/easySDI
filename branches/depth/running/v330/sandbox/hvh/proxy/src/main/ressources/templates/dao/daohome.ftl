...
<#if ejb3>
    ...
    public ${declarationName} findById( ${pojo.getJavaTypeName(clazz.identifierProperty, jdk5)} id) {
        ...
        try {
            ${declarationName} instance = (${declarationName})sessionFactory.getCurrentSession().get(${pojo.getDeclarationName()}.class, id);
    ...
    public void save(${declarationName} transientInstance) {
        log.debug("save ${declarationName} instance");
        try {
    ...
    public void saveOrUpdate(${declarationName} transientInstance) {
        log.debug("saveOrUpdate ${declarationName} instance");
        try {
    ...
    public void update(${declarationName} transientInstance) {
        log.debug("update ${declarationName} instance");
        try {
    ...
    public void delete(${declarationName} transientInstance) {
        log.debug("delete ${declarationName} instance");
        try {
    ...
    public void merge(${declarationName} transientInstance) {
        log.debug("merge ${declarationName} instance");
        try {
