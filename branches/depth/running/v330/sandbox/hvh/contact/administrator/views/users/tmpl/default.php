...
<form action="<?php echo JRoute::_('index.php?option=com_easysdi_contact&view=users'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<div id="filter-bar" class="btn-toolbar">
		<div class="filter-search btn-group pull-left">
			<label for="filter_search" class="element-invisible"><?php echo JText::_('COM_EASYSDI_CONTACT_FILTER_SEARCH_DESC');?></label>
			<input type="text" name="filter_search" id="filter_search" placeholder="<?php echo JText::_('COM_EASYSDI_CONTACT_SEARCH_IN_USER'); ?>" value="<?php echo $this->escape($this->state->get('filter.search')); ?>" title="<?php echo JText::_('COM_EASYSDI_SEARCH_IN_USER'); ?>" />
		</div>
			...
			<?php foreach ($this->items as $i => $item) :
                ...
                <td class="nowrap has-context">
					<div class="pull-left">
						...
						<div class="small">
							<?php echo JText::sprintf('JGLOBAL_LIST_ALIAS', $this->escape($item->username));?>
						</div>
					</div>
					<div class="pull-left">
						<?php
