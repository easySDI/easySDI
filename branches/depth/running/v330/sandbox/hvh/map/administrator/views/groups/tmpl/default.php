...
<div id="filter-bar" class="btn-toolbar">
		<div class="filter-search btn-group pull-left">
			...
			<input type="text" name="filter_search" id="filter_search" placeholder="<?php echo JText::_('COM_EASYSDI_MAP_SEARCH_IN_GROUP'); ?>" value="<?php echo $this->escape($this->state->get('filter.search')); ?>" title="<?php echo JText::_('COM_EASYSDI_SEARCH_IN_GROUP'); ?>" />
		</div>
	...
	<table class="table table-striped" id="groupList">
		<thead>
			...
			<th width="1%" class="nowrap center">
                ...
                <?php endif; ?>
              	<th class='left'>
				<?php echo JHtml::_('grid.sort', 'COM_EASYSDI_MAP_FORM_LBL_GROUP_NAME', 'a.name', $listDirn, $listOrder); ?>
		</th>
		<th class='left'>
		...
		<tbody>
			...
			<?php if (isset($item->ordering)): ?>
                ...
                <?php if (isset($this->items[0]->state)): ?>
				<td class="center">
					<?php echo JHtml::_('jgrid.published', $item->state, $i, 'groups.', $canChange, 'cb',$item->publish_up, $item->publish_down); ?>
				</td>
                <?php endif; ?>
