		...
		<div class="span10 form-horizontal">
			...
			<div class="tab-content">
				...
				<div class="tab-pane" id="policies">
					<fieldset>
						<a href="<?php echo JRoute::_('index.php?option=com_easysdi_service&view=policy&layout=wms&virtualservice_id='.JRequest::getVar('id',null)); ?>" class="btn"><?php echo JText::_('COM_EASYSDI_SERVICE_BTN_CREATE_POLICY');?></a>
						<table class="table" >
							<?php foreach($this->policies as $policy):?> 
								<tr>
									<td><?php echo $policy->name; ?></td>
									<td><a href="<?php echo JRoute::_('index.php?option=com_easysdi_service&view=policy&layout=wms&id='.$policy->id.'&virtualservice_id='.JRequest::getVar('id',null)); ?>" class="btn"><?php echo JText::_('COM_EASYSDI_SERVICE_BTN_MODIFY_POLICY');?></a></td>
								</tr>
							<?php endforeach; ?>
						</table>
					</fieldset>
