...
class WfsWebservice {
	public static function request ($params) {
		switch ($params['method']) {
			case 'getWmtsLayerForm':
				echo 'form';
				//echo WfsWebservice::getWmtsLayerForm($params);
				break;
			case 'setWmtsLayerSettings':
				echo 'save';
				/*if (WfsWebservice::setWmtsLayerSettings($params)) {
					echo 'OK';
				}*/
				break;
			default:
	...
	private static function getWfsLayerForm ($raw_GET) {
	...
	private static function getWfsLayerSettings ($physicalServiceID, $policyID, $layerID) {
	...
	private static function setWfsLayerSettings ($raw_GET) {
