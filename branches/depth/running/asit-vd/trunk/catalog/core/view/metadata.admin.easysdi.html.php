								...
								".$parentFieldsetName.".add(
												...
												Ext.Msg.confirm(
													 	...
													 	function(btn, text){
													 		if (btn == 'yes'){
																...
																Ext.Ajax.request({
																	url:'index.php?option=com_easysdi_catalog&task=deleteUploadedFile&file='+form.getForm().findField('".$currentName."').getValue(),
																	params:{},
																	method:'GET',
									...
									".$parentFieldsetName.".add(
										new Ext.Button({
											...
											handler: function(){
												var doit = true;
												if(form.getForm().findField('".$currentName."').getValue().length != 0){
													 Ext.Msg.confirm(
