...
<form action="<?php echo JRoute::_('index.php?option=com_easysdi_service&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="virtualservice-form" class="form-validate">
	<div class="width-60 fltlft">
		<fieldset class="adminform">
			<legend><?php echo JText::_('COM_EASYSDI_SERVICE_LEGEND_VIRTUALSERVICE'); ?></legend>
