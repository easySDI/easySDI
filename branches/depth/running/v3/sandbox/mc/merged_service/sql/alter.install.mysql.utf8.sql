...
ADD CONSTRAINT `#__sdi_versiontype_fk_policy` FOREIGN KEY (`policy_id`) REFERENCES `#__sdi_policy` (`id`);


ALTER TABLE `#__sdi_visibilitytype`
ADD CONSTRAINT `#__sdi_visibilitytype_fk_policy` FOREIGN KEY (`policy_id`) REFERENCES `#__sdi_policy` (`id`);
