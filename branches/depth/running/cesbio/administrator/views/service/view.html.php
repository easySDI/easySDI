 ...
 * View to edit
 */
class Easysdi_coreViewService extends JView
{
	protected $state;
	protected $item;
	protected $form;
	...
	protected function addToolbar()
	{
		...
		$this->canDo	= Easysdi_coreHelper::getActions($state->get('filter.category_id'),null, $this->item->id);

		JToolBarHelper::title(JText::_('COM_EASYSDI_CORE_TITLE_SERVICE'), 'service.png');
