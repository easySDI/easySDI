...
<form
	...
	method="post" name="adminForm" id="mapcontext-form"
	class="form-validate">
	<div class="width-60 fltlft">
		<fieldset class="adminform">
			<legend>
				<?php echo JText::_('COM_EASYSDI_MAP_LEGEND_MAPCONTEXT'); ?>
			</legend>
			<ul class="adminformlist">
				...
				<li><?php echo $this->form->getLabel('srs'); ?> <?php echo $this->form->getInput('srs'); ?>
				</li>
				...
				<li><?php echo $this->form->getLabel('centercoordinates'); ?> <?php echo $this->form->getInput('centercoordinates'); ?>
				</li>


				<li><?php echo $this->form->getLabel('maxresolution'); ?> <?php echo $this->form->getInput('maxresolution'); ?>
				</li>


				<li><?php echo $this->form->getLabel('maxextent'); ?> <?php echo $this->form->getInput('maxextent'); ?>
				</li>


				<li><?php echo $this->form->getLabel('abstract'); ?>
					<div class="clr"></div> <?php echo $this->form->getInput('abstract'); ?>
				</li>
