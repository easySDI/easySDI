...
<form action="<?php echo JRoute::_('index.php?option=com_easysdi_map&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="maplayer-form" class="form-validate">
	<div class="width-60 fltlft">
		<fieldset class="adminform">
			<legend><?php echo JText::_('COM_EASYSDI_MAP_LEGEND_MAPLAYER'); ?></legend>
			...
			<li><?php echo $this->form->getLabel('maplayergroup_id'); ?>
			<?php echo $this->form->getInput('maplayergroup_id'); ?></li>
			...
			<li><?php echo $this->form->getLabel('ispublished'); ?>
			<?php echo $this->form->getInput('ispublished'); ?></li>
