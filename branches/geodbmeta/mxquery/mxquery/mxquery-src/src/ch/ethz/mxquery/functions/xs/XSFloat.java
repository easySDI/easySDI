...
public class XSFloat extends XSConstructorIterator  {
...
//	currently float type uses double implementation
	...
	protected void init() throws MXQueryException {
		...
		switch (type) {
			...
			case Type.STRING :
				...
				createToken(new MXQueryFloat(dataVal));
				if ((facetsList != null) && facetsList.getLength() >0)
					checkFacets(new DoubleDV(),currentToken.getValueAsString());
				break;
			case Type.INTEGER :
	...
	private void createToken(MXQueryFloat value) throws MXQueryException {
			currentToken = new FloatToken(null, value);
	}
	
	public TypeInfo getStaticType() {
		return new TypeInfo(Type.FLOAT,Type.OCCURRENCE_IND_ZERO_OR_ONE,null,null);
	}		
	
	protected XDMIterator copy(Context context, XDMIterator[] subIters, Vector nestedPredCtxStack) throws MXQueryException {
		XSFloat copy = new XSFloat();
