 ...
 */
class Easysdi_serviceModelService extends JModelItem
{
	/**
	...
	protected function populateState()
	{
		...
		if ((!$user->authorise('core.edit.state', 'com_easysdi_service')) &&  (!$user->authorise('core.edit', 'com_easysdi_service'))){
