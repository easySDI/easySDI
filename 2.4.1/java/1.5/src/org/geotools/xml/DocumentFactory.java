 ...
 * @source $URL: http://svn.geotools.org/geotools/tags/2.4.1/modules/library/xml/src/main/java/org/geotools/xml/DocumentFactory.java $
 * @version $Id: DocumentFactory.java 22347 2006-10-24 01:57:23Z jdeolive $
 */
public class DocumentFactory {
     ...
     * @throws SAXException
     */
    public static Object getInstance(URI desiredDocument, Map hints, Level level,String user,String password)
        throws SAXException {
        SAXParser parser = getParser();

        XMLSAXHandler xmlContentHandler = null;
        if (user !=null && user.length() >0){
            xmlContentHandler =new XMLSAXHandler(desiredDocument,
                    hints,user,password);
        }else{
            xmlContentHandler =new XMLSAXHandler(desiredDocument,
                hints);
