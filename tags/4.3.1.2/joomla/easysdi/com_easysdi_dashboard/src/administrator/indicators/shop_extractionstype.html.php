...
?>
<div class="module-title nav-header"><i class="icon-cog" style="text-transform: none;"></i> <span id="total-ext">0</span> <?php echo JText::_('COM_EASYSDI_DASHBOARD_SHOP_IND_EXTRACTIONSTYPE_TITLE'); ?></div>
        ...
        jQuery.ajax({
            ...
            success: function(json) {
                ...
                if (json.data.total_ext > 0) {
                    ...
                    console.log(json.data.total_ext_manual);
                    console.log(pctManu);
                    console.log(pctAuto);

                    /* title */
                    jQuery('#total-ext').html(json.data.total_ext);
