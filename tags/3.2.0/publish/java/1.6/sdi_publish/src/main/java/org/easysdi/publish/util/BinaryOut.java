 ...
 * @throws PublishConfigurationException 
     */
    public BinaryOut(String s) throws PublishConfigurationException {
        try {
            OutputStream os = new FileOutputStream(s);
            out = new BufferedOutputStream(os);
        }
        catch (IOException e) {
        	throw new PublishConfigurationException("Impossible to write for ressource:"+s+" cause:"+e.getMessage()); 
        }
    }
 ...
 * @throws PublishConfigurationException 
     */
    public BinaryOut(Socket socket) throws PublishConfigurationException {
        try {
            OutputStream os = socket.getOutputStream();
            out = new BufferedOutputStream(os);
        }
        catch (IOException e) {
        	throw new PublishConfigurationException("Impossible to write for ressource:"+socket+" cause:"+e.getMessage());  
        }
    }
