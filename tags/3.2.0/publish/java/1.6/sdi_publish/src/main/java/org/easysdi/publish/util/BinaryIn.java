 ...
 *
 *  % java BinaryIn http://www.cs.princeton.edu/introcs/cover.jpg output.jpg
 *
 *************************************************************************/
 ...
 * @throws DataInputException 
     */
    public BinaryIn(Socket socket) throws TransformationException {
        try {
            ...
            throw new TransformationException("The supplied ressource is unreachable: "+socket);
        }
    }
 ...
 * @throws DataInputException 
     */
    public BinaryIn(URL url) throws TransformationException {
        try {
            ...
            throw new TransformationException("The supplied ressource is unreachable: "+url);
        }
    }
 ...
 * @throws DataInputException 
     */
    public BinaryIn(String s) throws TransformationException {
        ...
        try {
            ...
            throw new TransformationException("The supplied ressource is unreachable: "+s);
        }
    }
