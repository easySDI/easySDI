...
public final class GregorianAttrToken extends NamedToken {
	private final MXQueryGregorian value;

	public GregorianAttrToken(Identifier id, MXQueryGregorian val, QName name, XDMScope scope) throws MXQueryException {
	...
	public NamedToken copy(QName newName) throws MXQueryException {
		return new GregorianAttrToken(this.id, this.value, newName, dynamicScope);
	}
	
	public Token copy() {
		return new GregorianAttrToken(this);
	}
}
