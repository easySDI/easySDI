...
class HTML_config {
	...
	function showConfig($option, $coreList, $catalogItem, $catalogList, $shopItem, $shopList, $proxyItem, $proxyList, $monitorItem, $monitorList, $publishItem, $publishList,$fieldsLength, $attributetypelist )
	{
		global $mainframe;
