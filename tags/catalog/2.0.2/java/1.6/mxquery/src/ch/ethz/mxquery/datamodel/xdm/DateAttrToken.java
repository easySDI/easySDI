...
public final class DateAttrToken extends NamedToken {
	private final MXQueryDate value;

	public DateAttrToken(Identifier id, MXQueryDate value, QName name, XDMScope scope) throws MXQueryException {
