...
class publishConfig extends JTable
{
	...
	{
		parent::__construct ( '#__easysdi_publish_config', 'id', $db ) ;    		
	}
}
...
class diffusor extends JTable
{
	...
	function __construct( &$db )
	{
		parent::__construct ( '#__easysdi_publish_diffusor', 'id', $db ) ;
	}
}
...
class publishUser extends JTable
{
	...
	function __construct( &$db )
	{
		parent::__construct ( '#__easysdi_publish_user', 'id', $db ) ;
	}
}
...
class script extends JTable
{
	...
	function __construct( &$db )
	{
		parent::__construct ( '#__easysdi_publish_script', 'id', $db ) ;
	}
}
