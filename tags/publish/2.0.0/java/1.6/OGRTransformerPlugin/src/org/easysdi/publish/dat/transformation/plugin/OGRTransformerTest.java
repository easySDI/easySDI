...
public class OGRTransformerTest {
	...
	public static void main(String... args){
		...
		try {			
			...
			URLs.add("http://localhost/testdata/tl_2008_48_taz00.shp");
			URLs.add("http://localhost/testdata/tl_2008_48_taz00.shx");
			URLs.add("http://localhost/testdata/tl_2008_48_taz00.dbf");
