 ...
 */
class Easysdi_catalogControllerMetadataForm extends Easysdi_catalogController
{
	...
	public function edit()
	{
		...
		// Get the model.
		$model = $this->getModel('MetadataForm', 'Easysdi_catalogModel');
	...
	public function save()
	{
		...
		if ($data === false) {
			...
			$this->setRedirect(JRoute::_('index.php?option=com_easysdi_catalog&view=metadataform&layout=edit&id='.$id, false));
			return false;
		}
