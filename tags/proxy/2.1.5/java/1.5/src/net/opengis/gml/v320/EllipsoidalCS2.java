...
public class EllipsoidalCS2
    extends JAXBElement<EllipsoidalCSType>
{

    protected final static QName NAME = new QName("http://www.opengis.net/gml", "EllipsoidalCS");

    public EllipsoidalCS2(EllipsoidalCSType value) {
