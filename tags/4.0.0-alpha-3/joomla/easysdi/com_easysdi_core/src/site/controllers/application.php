 ...
 */
class Easysdi_coreControllerApplication extends Easysdi_coreController
{
	...
	public function edit()
	{
		...
		$this->setRedirect(JRoute::_('index.php?option=com_easysdi_core&view=applicationform&layout=edit', false));
	}
