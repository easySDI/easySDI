...
/**
 * The outcome of an FME Desktop process task.
 *
 * @author Florent Krin
 */
public class FmeDesktopResult implements ITaskProcessorResult {

    /**
     * The string that identifies the type of error that prevented the FME Desktop task from completing,
     * if any.
     */
    private String errorCode;

    /**
     * Additional information about the type of error that prevented the FME Desktop task from completing,
     * if any.
     */
    private String message;

    /**
     * The final state of the FME Desktop task.
     */
    ...
    /**
     * Defines the type of error that prevented this FME Desktop task from completing successfully.
     *
    ...
    /**
     * Defines additional information about the error that prevented this FME Desktop task from completing
     * successfully.
     *
    ...
    /**
     * Defines the final state of the FME Desktop task.
     *
    ...
    /**
     * Defines the data item request that required this FME Desktop task as part of its process.
     * <p>
     * <i>Note that some of its properties may have been updated by the task plugin.</i>
     * </p>
     *
     * @param requestToProcess the request that needed to be processed by FME Desktop
     */
