...
public class InsertBefore implements UpdatePrimitive {
	private Identifier targetId;
	private UpdateableStore store;

	public InsertBefore(Identifier targetId, UpdateableStore sourceStore) {
	...
	public void applyUpdate() throws MXQueryException {
		...
		if (sr instanceof UpdateableStore) {
			...
			ds.insertBefore(this.targetId, this.store);
			ds.setModified(true);
		}
		else 
	...
	public int getType() {
		return UpdatePrimitive.INSERT_BEFORE;
	}
