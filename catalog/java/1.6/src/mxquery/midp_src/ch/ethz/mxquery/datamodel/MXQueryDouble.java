...
public class MXQueryDouble  implements MXQueryNumber  {
	...
	public MXQueryNumber add(int i){
		return new MXQueryDouble(this.val + i);
	} 
	...
	public boolean equals(MXQueryNumber d) {
		return (this.val == d.getDoubleValue().val);
	}	
	...
	public int compareTo(int i) {
		return this.compareTo(new MXQueryDouble(i));
	}
...
//		return f.format(val);
	...
	public MXQueryDouble limitFloat() {
		return this;
	}	
