...
public class ReplaceValue implements UpdatePrimitive {
	private Identifier targetId;
	private String stringValue;

	public ReplaceValue(Identifier targetId, String stringValue) {
	...
	public void applyUpdate() throws MXQueryException {
		...
		if (src instanceof UpdateableStore) {
			...
			ds.replaceValue(this.targetId, this.stringValue);
			ds.setModified(true);
		}
		else 
	...
	public int getType() {
		return UpdatePrimitive.REPLACE_VALUE;
	}
