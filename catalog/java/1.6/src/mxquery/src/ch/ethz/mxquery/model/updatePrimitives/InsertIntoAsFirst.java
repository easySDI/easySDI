...
public class InsertIntoAsFirst implements UpdatePrimitive {
	private Identifier targetId;
	private UpdateableStore store;

	public InsertIntoAsFirst(Identifier targetId, UpdateableStore sourceStore) {
	...
	public void applyUpdate() throws MXQueryException {
		...
		if (sr instanceof UpdateableStore) {
			...
			ds.insertIntoAsFirst(this.targetId, this.store);
			ds.setModified(true);
		}
		else 
	...
	public int getType() {
		return UpdatePrimitive.INSERT_INTO_AS_FIRST;
	}
