...
public class LazySequentialFIFOStore extends LazyFIFOStore implements RandomRead {
	...
	public LazySequentialFIFOStore(int id, int blockSize, WindowBuffer container){
		super(id, container);
