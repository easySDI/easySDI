...
public class RandomFIFOStoreSchema extends FIFOStore implements RandomRead {
...
//	private Map<Integer,BufferItem> tokenStarts = null;
	...
	public RandomFIFOStoreSchema(int id, int blockSize, WindowBuffer container){
		super(id, container);
...
//			System.out.print(crtBuff.getFirstTokenId()+ " ");
//		}
//		
//		System.out.println();
//	}
