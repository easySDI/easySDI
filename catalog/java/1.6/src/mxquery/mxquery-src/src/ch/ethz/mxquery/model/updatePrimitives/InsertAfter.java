...
public class InsertAfter implements UpdatePrimitive {
	private Identifier targetId;
	private UpdateableStore store;

	public InsertAfter(Identifier targetId, UpdateableStore sourceStore) {
	...
	public void applyUpdate() throws MXQueryException {
		...
		if (sr instanceof UpdateableStore) {
			...
			ds.insertAfter(this.targetId, this.store);
			ds.setModified(true);
		}
		else 
	...
	public int getType() {
		return UpdatePrimitive.INSERT_AFTER;
	}
