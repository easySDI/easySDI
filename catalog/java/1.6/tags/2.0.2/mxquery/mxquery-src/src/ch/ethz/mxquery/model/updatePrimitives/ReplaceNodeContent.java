...
public class ReplaceNodeContent implements UpdatePrimitive {
	private Identifier targetId;
	private UpdateableStore store;

	public ReplaceNodeContent(Identifier targetId, UpdateableStore sourceStore) {
	...
	public void applyUpdate() throws MXQueryException {
		...
		if (src instanceof UpdateableStore) {
			...
			ds.replaceNodeContent(this.targetId, this.store);
			ds.setModified(true);
		}
		else 
	...
	public int getType() {
		return UpdatePrimitive.REPLACE_NODE_CONTENT;
	}
