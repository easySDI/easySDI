...
class TOOLBAR_relation {
	function _DEFAULT() {
		JToolBarHelper::title(JText::_("CATALOG_LIST_RELATION"));
		
		JToolBarHelper::addNew('newRelation');
		JToolBarHelper::editList('editRelation');
		JToolBarHelper::deleteList('','removeRelation');
