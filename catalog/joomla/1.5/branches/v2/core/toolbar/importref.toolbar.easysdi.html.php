...
class TOOLBAR_importref {
	function _DEFAULT() {
		JToolBarHelper::title(JText::_("CATALOG_LIST_IMPORTREF"));
	...
	function _EDIT() {
		...
		JToolBarHelper::spacer();
		JToolBarHelper::custom( 'cancelImportRef', 'back.png', 'back.png', JTEXT::_("CORE_MENU_BACK"), false );
	}
}
?>