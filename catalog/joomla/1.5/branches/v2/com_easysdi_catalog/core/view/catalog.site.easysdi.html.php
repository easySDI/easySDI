		...
		<form name="catalog_search_form" id="catalog_search_form"  method="GET">
			...
			<div onClick ="document.getElementById('simulatedTabIndex').value = '1';
						  ...
						  <?php if ($simulatedTabIndex == 2)
								...
								<?php echo JText::_("CATALOG_SEARCH_TEXT_SIMPLE_CRITERIA");?></div>
			<div onClick ="document.getElementById('simulatedTabIndex').value = '2';
						  ...
						  <?php if ($simulatedTabIndex == 2)
						  		...
						  		{echo "class='mdPanSelectable'" ;} ?>>
						  <?php echo JText::_("CATALOG_SEARCH_TEXT_ADVANCED_CRITERIA");?></div>
			-->			  
			...
			<table width="100%" class="mdCatContent">
				<tr>
					<td align="left"><b><?php echo JText::_("CATALOG_SEARCH_FILTER_TITLE");?></b>&nbsp;
					...
					<td class="catalog_controls">
						<button id="simple_search_button" name="simple_search_button" type="submit" class="easysdi_search_button">
							<?php echo JText::_("CATALOG_SEARCH_SEARCH_BUTTON"); ?></button>
						<button type="submit" id="easysdi_clear_button" class="easysdi_clear_button">
							<?php echo JText::_("CATALOG_SEARCH_CLEAR_BUTTON"); ?></button>
					</td>
				</tr>
				<tr>
					...
					<td><input id="advSearchRadio" name="advSearchRadio" type="checkBox" value=""/>
						<span><?php echo JText::_("CATALOG_SEARCH_TEXT_ADVANCED_CRITERIA"); ?></span></td>		
				</tr>
				<tr>
					<td><?php echo JText::_("CATALOG_SEARCH_FILTER_OBJECTTYPE");?></td>
					<td><?php echo JHTML::_("select.genericlist", $objecttypes, 'objecttype_id', 'size="1" class="inputbox" ', 'value', 'text', JRequest::getVar('objecttype_id')); ?></td>
					<td></td>		
				</tr>
			</table>
			</div>
