...
var ThesaurusReader = function(config){
    ...
    this.getByTerm = function(){
        ...
        if(this.getValue().length < this.minLength) {
            Ext.Msg.alert(this.obj.transl('Warning'), '&gt;= ' +this.minLength+' '+this.obj.transl('characters required'));
            return false;
        }
        ...
        this.obj.thesRoot.setText(this.obj.transl('Found'));  
        Ext.Ajax.request({
    ...
    this.getTopConcepts = function(conceptURI){
        ...
        if(conceptURI==this.INSPIRE)
            this.thesRoot.setText(this.transl('INSPIRE themes'));
        else
            this.thesRoot.setText(this.transl('Top concepts'));
    ...
    this.getById = function(theNode){
        ...
        var nt = new Ext.tree.TreeNode({text: this.transl("NT"), termId: 'nt', icon: this.appPath+'img/indicator.gif'});
        ...
        var bt = new Ext.tree.TreeNode({text: this.transl("BT"),
                                        termId: 'bt',
        ...
        var rt = new Ext.tree.TreeNode({text: this.transl("RT"), termId: 'rt', icon:this.appPath+'img/indicator.gif'});
    ...
    var tb = new Ext.Toolbar(
    	[{xtype: 'button', text:this.transl("Use"), icon:this.appPath+'img/drop-yes.gif', cls:'x-btn-text-icon', handler: this.returnTerm, scope:this}, '-', 'xxx']
    );
    ...
    config.tbar = [
    	{handler: function(){this.getTopConcepts(this.INSPIRE);}, 
    	 icon:this.appPath+'img/inspire.gif', cls:'x-btn-icon', tooltip: this.transl('INSPIRE themes'),
    	 scope:this},
    	{handler: function(){this.getTopConcepts(this.CONCEPT);}, 
    	 icon:this.appPath+'img/eeaicon.gif', cls:'x-btn-icon', tooltip: this.transl('GEMET top concepts'),
    	 scope:this}, 
    	"-", 
    	this.transl("Search")+': ', 
    	searchField];
