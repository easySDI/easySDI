...
function listCatalogContent($pageNav,$cswResults,$option, $total,$searchCriteria){
	...
	<?php
		...
		foreach($nodes  as $metadata){
			...
			<td><a class="modal" title="<?php echo JText::_("EASYSDI_VIEW_MD"); ?>" href="./index.php?tmpl=component&option=<?php echo $option; ?>&task=showMetadata&id=<?php echo $md->getFileIdentifier();  ?>" rel="{handler:'iframe',size:{x:500,y:500}}"> <?php echo $md->getDataIdentificationTitle();?></a></td>			
			</tr>			
				<?php		
		}		
	?>
