...
$migrateServletTablesQuery ="SET FOREIGN_KEY_CHECKS=0;
			...
			CREATE TABLE `last_query_results` (
			  ...
			  CONSTRAINT `FK_LAST_QUERY_QUERY` FOREIGN KEY (`ID_QUERY`) REFERENCES `queries` (`ID_QUERY`) ON DELETE CASCADE ON UPDATE NO ACTION
			) ENGINE=InnoDB DEFAULT CHARSET=utf8;
			...
			CREATE TABLE `overview_queries` (
			  ...
			  CONSTRAINT `FK_OVERVIEWQUERY_QUERY` FOREIGN KEY (`ID_QUERY`) REFERENCES `queries` (`ID_QUERY`) ON DELETE CASCADE ON UPDATE NO ACTION,
			  CONSTRAINT `FK_OW_QUERY_PAGE` FOREIGN KEY (`ID_OVERVIEW_PAGE`) REFERENCES `overview_page` (`ID_OVERVIEW_PAGE`) ON DELETE CASCADE ON UPDATE NO ACTION
			) ENGINE=InnoDB DEFAULT CHARSET=utf8;
			...
			CREATE TABLE `query_validation_results` (
			  ...
			  CONSTRAINT `fk_query_validation_results_queries1` FOREIGN KEY (`ID_QUERY`) REFERENCES `queries` (`ID_QUERY`) ON DELETE NO ACTION ON UPDATE NO ACTION
			...
			CREATE TABLE `query_validation_settings` (
			  ...
			  CONSTRAINT `fk_query_validation_settings_queries1` FOREIGN KEY (`ID_QUERY`) REFERENCES `queries` (`ID_QUERY`) ON DELETE NO ACTION ON UPDATE NO ACTION
			) ENGINE=InnoDB DEFAULT CHARSET=latin1;
