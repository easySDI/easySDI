...
public class LogManager {
     ...
     */
    private void setAggregateLogs(
            Map<Date, AbstractAggregateLogEntry> aggregLogsSet) {
     ...
     *                      set defined by the other criteria. This is useful
     *                      for paging purposes
     * @return              the set of aggragate log entries matching the 
     *                      given criteria
     */
    public Map<Date, 
               AbstractAggregateLogEntry> getAggregLogsSubset(Calendar minDate,
                    Calendar maxDate, Integer maxResults, Integer startIndex) {
