 ...
 */
class Easysdi_contactModelcategory extends JModelAdmin {
     ...
     * @since	1.6
     */
    public function getTable($type = 'Category', $prefix = 'Easysdi_contactTable', $config = array()) {
    ...
    public function getForm($data = array(), $loadData = true) {
        ...
        // Get the form.
        $form = $this->loadForm('com_easysdi_contact.category', 'category', array('control' => 'jform', 'load_data' => $loadData));
        if (empty($form)) {
            return false;
        }
    ...
    protected function loadFormData() {
        ...
        $data = JFactory::getApplication()->getUserState('com_easysdi_contact.edit.category.data', array());
