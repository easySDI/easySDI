...
if ($saveOrder) {
    $saveOrderingUrl = 'index.php?option=com_easysdi_catalog&task=resourcetypelinks.saveOrderAjax&tmpl=component';
    JHtml::_('sortablelist.sortable', 'resourcetypelinkList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
...
<form action="<?php echo JRoute::_('index.php?option=com_easysdi_catalog&view=resourcetypelinks'); ?>" method="post" name="adminForm" id="adminForm">
    <?php if (!empty($this->sidebar)): ?>
        ...
        this.form.submit();"><i class="icon-remove"></i></button>
            ...
            <table class="table table-striped" id="resourcetypelinkList">
                <thead>
                    <tr>
                        ...
                        <th class='left'>
                            <?php echo JHtml::_('grid.sort', 'COM_EASYSDI_CATALOG_RESOURCETYPELINKS_PARENT_ID', 'a.parent', $listDirn, $listOrder); ?>
                        </th>

                        <th class='left'>
                            <?php echo JHtml::_('grid.sort', 'COM_EASYSDI_CATALOG_RESOURCETYPELINKS_CHILD_ID', 'a.child', $listDirn, $listOrder); ?>
                        </th>
                ...
                <tbody>
                    ...
                    foreach ($this->items as $i => $item) :
                        ...
                        <tr class="row<?php echo $i % 2; ?>">
                            ...
                            <?php if (isset($this->items[0]->state)): ?>
                                <td class="center">
                                    <?php echo JHtml::_('jgrid.published', $item->state, $i, 'resourcetypelinks.', $canChange, 'cb'); ?>
                                </td>
                            <?php endif; ?>
                            ...
                            <td>
                                <?php echo JHtml::_('grid.boolean', $i, $item->viralversioning); ?>
                            </td>
