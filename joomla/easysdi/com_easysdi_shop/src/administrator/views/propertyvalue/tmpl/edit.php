...
<script type="text/javascript">
    ...
    {
        if(task == 'propertyvalue.cancel'){
            Joomla.submitform(task, document.getElementById('propertyvalue-form'));
        }
        else{
            
            if (task != 'propertyvalue.cancel' && document.formvalidator.isValid(document.id('propertyvalue-form'))) {
...
<form action="<?php echo JRoute::_('index.php?option=com_easysdi_shop&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="propertyvalue-form" class="form-validate">
   <div class="row-fluid">
