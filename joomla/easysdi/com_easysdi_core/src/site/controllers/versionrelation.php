 ...
 */
class Easysdi_coreControllerVersionrelation extends Easysdi_coreController
{
	...
	public function edit()
	{
		...
		// Get the model.
		$model = $this->getModel('Versionrelation', 'Easysdi_coreModel');
		...
		$this->setRedirect(JRoute::_('index.php?option=com_easysdi_core&view=versionrelationform&layout=edit', false));
	}
