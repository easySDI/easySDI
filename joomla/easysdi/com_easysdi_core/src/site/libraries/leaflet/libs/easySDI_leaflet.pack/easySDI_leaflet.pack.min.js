...
layer.name+'</a>'+'</h4>'+'</div>'+'<div id="collapse'+layer.layer._leaflet_id+'" class="panel-collapse collapse '+first_layer+'" role="tabpanel" aria-labelledby="heading'+layer.layer._leaflet_id+'">'+'<div class="panel-body">'+'<pre class="featureInfo easygetfeature_pre">'+request.html+'</pre>'+'</div>'+'</div>'+'</div>';tmp_collapse+=collapse;request.html=collapse_start+tmp_collapse+collapse_end;first_layer="";var evt=new CustomEvent('getFeature',request);window.dispatchEvent(evt);nbr_active_layer--;}else{if(ul.length>0){jQuery.each(ul,function(){request.html='<table class="featureInfo easygetfeature_table">'+jQuery(this).html()+'</table>';});var collapse='<div class="panel panel-default">'+'<div class="panel-heading" role="tab" id="headingOne">'+'<h4 class="panel-title">'+'<a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse'+layer.layer._leaflet_id+'" aria-expanded="true" aria-controls="collapse'+layer.layer._leaflet_id+'">'+
layer.name+'</a>'+'</h4>'+'</div>'+'<div id="collapse'+layer.layer._leaflet_id+'" class="panel-collapse collapse '+first_layer+'" role="tabpanel" aria-labelledby="heading'+layer.layer._leaflet_id+'">'+'<div class="panel-body">'+'<pre class="featureInfo easygetfeature_pre">'+request.html+'</pre>'+'</div>'+'</div>'+'</div>';tmp_collapse+=collapse;request.html=collapse_start+tmp_collapse+collapse_end;first_layer="";var evt=new CustomEvent('getFeature',request);window.dispatchEvent(evt);nbr_active_layer--;}else{data=data.replace('GetFeatureInfo results:','').trim();if(data.length>0&&data.search('Search returned no results.')==-1&&data.search('body')==-1){var collapse='<div class="panel panel-default">'+'<div class="panel-heading" role="tab" id="headingOne">'+'<h4 class="panel-title">'+'<a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse'+layer.layer._leaflet_id+'" aria-expanded="true" aria-controls="collapse'+layer.layer._leaflet_id+'">'+
...
data+'</div>'+'</div>'+'</div>';tmp_collapse+=collapse;request.html=collapse_start+tmp_collapse+collapse_end;first_layer="";var evt=new CustomEvent('getFeature',request);window.dispatchEvent(evt);nbr_active_layer--;}}}}
setTimeout(function(){_this.updateResults();},2000);}}).fail(function(){request.html=false;});}
