...
(function (factory, window) {
    ...
    var LocateControl = L.Control.extend({
        options: {
            ...
            showPopup: true,
            strings: {title:"Localisez moi",metersUnit:"meters",feetUnit:"feet",popup:"Vous êtes dans un rayon de {distance} m de ce point",outsideMapBoundsMsg:"Vous êtes en dehors des limites de cette carte"
            },
