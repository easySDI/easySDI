 ...
 */
class Easysdi_coreTableresource extends JTable {
    ...
    public function bind($array, $ignore = '') {
		...
		//Support for multiple or not foreign key field: resourcetype_id
			if(isset($array['resourcetype_id'])){
				if(is_array($array['resourcetype_id'])){
					$array['resourcetype_id'] = implode(',',$array['resourcetype_id']);
				}
				else if(strrpos($array['resourcetype_id'], ',') != false){
					$array['resourcetype_id'] = explode(',',$array['resourcetype_id']);
				}
				else if(empty($array['resourcetype_id'])) {
					$array['resourcetype_id'] = '';
				}
			}
