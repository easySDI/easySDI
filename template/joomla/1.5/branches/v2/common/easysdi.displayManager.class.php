 ...
 * Copyright (C) 2008 DEPTH SA, Chemin d√¢‚Ç¨‚Ñ¢Arche 40b, CH-1870 Monthey, easysdi@depth.ch 
 *
	...
	*/
	...
	function DisplayMetadata ($xslStyle, $xml)
	{
		...
		if ($print !=1 )
		{
			...
			/* Onglet diffusion, si et seulement si le shop est installÈ et que l'objet est diffusable*/
			if ($shopExist)
			{
				$myHtml .= "
