...
{script_path='libs/easysdi_leaflet/easysdi_leaflet.js';for(var i=0;i<scripts.length;i++){if(scripts[i].src.indexOf(script_path)>-1){var local_url=scripts[i].src.substring(0,scripts[i].src.indexOf(script_path));}}}
...
return false;};_this.getFeatureUrl=function(layer,map,loc){if(!isset(layer))return false;if(layer.data.serviceconnector!='WMS'&&layer.data.serviceconnector!='WMTS')return false;var cap=_this.getCapabilities(layer.data.servicealias,layer);if(!isset(cap)||typeof cap!=='object')return null;return _getFeatureUrl(cap,layer,map,loc);};return _this;};easySDImap=function(obj,data,options){var params={};jQuery.extend(params,options);var _easySDImap={};var map;var baseLayers={};var overlays={};var services={};var mapOptions={zoomControl:false,attributionControl:false,dragging:false,touchZoom:false,doubleClickZoom:false,scrollWheelZoom:false,boxZoom:false,keyboard:false,};var container;var controlLayer,controlLegend,controlFeature;var serviceConnector;var lastBaseLayer=null;var baseLayerGroup='';var url_obj=urlObject(window.location.href);var lang;var boundsLatLng;var contextMapData;_easySDImap.params=params;var pushTool=function(alias,control,params){_easySDImap.tools.push({alias:alias,control:control,params:params});}
...
_this.sidebar=L.control.sidebar('sidebar',options);_this.sidebar.addTo(map);return _this;};if(data===undefined){var textarea=obj.find('textarea');contextMapData=jQuery.parseJSON(textarea.val());textarea.remove();}else{contextMapData=data;}
