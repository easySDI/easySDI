 ...
 */
class Easysdi_contactViewCategories extends JViewLegacy {
    ...
    public function display($tpl = null) {
        ...
        Easysdi_contactHelper::addSubmenu('categories');
    ...
    protected function addToolbar() {
        ...
        JToolBarHelper::title(JText::_('COM_EASYSDI_CONTACT_HEADER_CATEGORIES'), 'categories.png');
        ...
        JHtmlSidebar::setAction('index.php?option=com_easysdi_contact&view=categories');
