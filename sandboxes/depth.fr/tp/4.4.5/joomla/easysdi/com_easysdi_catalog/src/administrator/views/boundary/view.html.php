 ...
 * View to edit
 */
class Easysdi_catalogViewBoundary extends JViewLegacy
{
	protected $state;
	protected $item;
	protected $form;
	...
	protected function addToolbar()
	{
		...
		if (empty($this->item->id)) {
			JToolBarHelper::cancel('boundary.cancel', 'JTOOLBAR_CANCEL');
		}
		else {
			JToolBarHelper::cancel('boundary.cancel', 'JTOOLBAR_CLOSE');
		}
