...
class Easysdi_processingModelorder extends JModelAdmin {
    ...
    public function getItem($pk = null) {
        if ($item = parent::getItem($pk)) {
            ...
            $query
                ->select('p.name AS processing, p.parameters AS processing_parameters, p.auto AS processing_auto, p.command AS processing_command, p.contact_id AS processing_contact_id, p.map_id AS processing_map_id, p.plugins AS plugins')
