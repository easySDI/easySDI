...
/**
 * boundarycategory Table class
 */
class Easysdi_catalogTableboundarycategory extends sdiTable {
    ...
    public function bind($array, $ignore = '') {
		...
		if(($task == 'save' || $task == 'apply') && (!JFactory::getUser()->authorise('core.edit.state','com_easysdi_catalog.boundarycategory.'.$array['id']) && $array['state'] == 1)){
			$array['state'] = 0;
		}
    ...
    */
    protected function _getAssetName() {
        $k = $this->_tbl_key;
        return 'com_easysdi_catalog.boundarycategory.' . (int) $this->$k;
    }
