...
if ($saveOrder) {
    $saveOrderingUrl = 'index.php?option=com_easysdi_catalog&task=boundaries.saveOrderAjax&tmpl=component';
    JHtml::_('sortablelist.sortable', 'boundaryList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
...
<form action="<?php echo JRoute::_('index.php?option=com_easysdi_catalog&view=boundaries'); ?>" method="post" name="adminForm" id="adminForm">
    <?php if (!empty($this->sidebar)): ?>
        ...
        this.form.submit();"><i class="icon-remove"></i></button>
            ...
            <table class="table table-striped" id="boundaryList">
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    foreach ($this->items as $i => $item) :
                        ...
                        <tr class="row<?php echo $i % 2; ?>" sortable-group-id="<?php echo $item->category_id?>">
                            ...
                            <?php if (isset($this->items[0]->state)): ?>
                                <td class="center">
                                    <?php echo JHtml::_('jgrid.published', $item->state, $i, 'boundaries.', $canChange, 'cb'); ?>
                                </td>
                            <?php endif; ?>
                            <td>
