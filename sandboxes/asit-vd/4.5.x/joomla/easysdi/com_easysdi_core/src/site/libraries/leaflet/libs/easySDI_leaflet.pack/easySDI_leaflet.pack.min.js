...
return _this;}
var easySDImap;jQuery(document).ready(function($){var script_path='libs/easySDI_leaflet.pack/easySDI_leaflet.pack.min.js';var scripts=document.getElementsByTagName("script");var local_url='';for(var i=0;i<scripts.length;i++){if(scripts[i].src.indexOf(script_path)>-1){var local_url=scripts[i].src.substring(0,scripts[i].src.indexOf(script_path));}}
