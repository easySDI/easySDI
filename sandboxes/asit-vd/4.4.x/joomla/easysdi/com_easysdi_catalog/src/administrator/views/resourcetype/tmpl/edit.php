...
<script type="text/javascript">
    ...
    {
        if (task == 'resourcetype.cancel') {
            Joomla.submitform(task, document.getElementById('resourcetype-form'));
        }
        else {

            if (task != 'resourcetype.cancel' && document.formvalidator.isValid(document.id('resourcetype-form'))) {
...
<form action="<?php echo JRoute::_('index.php?option=com_easysdi_catalog&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="resourcetype-form" class="form-validate">
    <div class="row-fluid">
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="details">
                    ...
                    <div class="control-group">
                        <div class="control-label"><?php echo $this->form->getLabel('fragment'); ?></div>
