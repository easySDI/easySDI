 ...
 */
class Easysdi_catalogModelmetadatas extends JModelList
{
    ...
    public function __construct($config = array())
    {
        if (empty($config['filter_fields'])) {
            $config['filter_fields'] = array(
                ...
                'modified', 'a.modified',
                'ordering', 'a.ordering',
                'metadatastate_id', 'a.metadatastate_id',
                'accessscope_id', 'a.accessscope_id',
                'name', 'a.name',
                'published', 'a.published',
                'archived', 'a.archived',
                'lastsynchronization', 'a.lastsynchronization',
                'synchronized_by', 'a.synchronized_by',
