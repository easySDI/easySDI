...
_this.update();}
return _this;}
var easySDImap;jQuery(document).ready(function($){var script_path='libs/easySDI_leaflet.pack/easySDI_leaflet.pack.min.js';if(jQuery('script[src$="'+script_path+'"]').length){console.log(jQuery('script[src$="'+script_path+'"]'));var local_url=jQuery('script[src$="'+script_path+'"]').attr('src').replace(script_path,'');}else{script_path='libs/easysdi_leaflet/easysdi_leaflet.js';var local_url=jQuery('script[src$="'+script_path+'"]').attr('src').replace(script_path,'');}
