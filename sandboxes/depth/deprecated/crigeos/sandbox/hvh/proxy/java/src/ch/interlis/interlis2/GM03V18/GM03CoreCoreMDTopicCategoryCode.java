...
/**
 * <p>Java class for GM03Core.Core.MD_TopicCategoryCode.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="GM03Core.Core.MD_TopicCategoryCode">
 ...
 * 
 */
@XmlType(name = "GM03Core.Core.MD_TopicCategoryCode")
@XmlEnum
public enum GM03CoreCoreMDTopicCategoryCode {
    ...
    GM03CoreCoreMDTopicCategoryCode(String v) {
        value = v;
    }
    ...
    public static GM03CoreCoreMDTopicCategoryCode fromValue(String v) {
        for (GM03CoreCoreMDTopicCategoryCode c: GM03CoreCoreMDTopicCategoryCode.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
