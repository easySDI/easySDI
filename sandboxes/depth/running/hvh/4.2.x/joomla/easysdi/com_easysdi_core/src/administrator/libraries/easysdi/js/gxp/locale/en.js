...
GeoExt.Lang.add("en", {
    ...
    "gxp.plugins.Print.prototype": {
        ...
        googleLayerCanNotBePrinted: "Google layer can not be printed for copyright reasons.",
        bingLayerCanNotBePrinted: "Bing layer can not be printed for copyright reasons.",
        someLayersNotPrintableText: "Some layers can not be printed.",
