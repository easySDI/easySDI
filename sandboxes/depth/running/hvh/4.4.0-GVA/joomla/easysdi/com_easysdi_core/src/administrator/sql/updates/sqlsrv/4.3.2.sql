...
ALTER TABLE [sdi_sdi_pricing_profile] ALTER COLUMN [fixed_fee]  decimal(19,2) NULL;
ALTER TABLE [sdi_sdi_pricing_profile]  ALTER COLUMN [surface_rate]  decimal(19,2) NULL;
ALTER TABLE [sdi_sdi_pricing_profile] ALTER COLUMN [min_fee]  decimal(19,2) NULL ;
ALTER TABLE [sdi_sdi_pricing_profile]  ALTER COLUMN [max_fee]  decimal(19,2) NULL;
ALTER TABLE [sdi_sdi_pricing_order_supplier_product_profile] ALTER COLUMN [cfg_fixed_fee]  decimal(19,2) NOT NULL;
ALTER TABLE [sdi_sdi_pricing_order_supplier_product_profile] ALTER COLUMN [cfg_surface_rate]  decimal(19,2) NOT NULL;
ALTER TABLE [sdi_sdi_pricing_order_supplier_product_profile] ALTER COLUMN [cfg_min_fee]  decimal(19,2) NOT NULL ;
ALTER TABLE [sdi_sdi_pricing_order_supplier_product_profile] ALTER COLUMN [cfg_max_fee]  decimal(19,2) NOT NULL ;
ALTER TABLE [sdi_sdi_pricing_order_supplier_product_profile] ALTER COLUMN [cfg_pct_category_profile_discount]  decimal(19,2) NOT NULL ;
ALTER TABLE [sdi_sdi_pricing_order_supplier_product] ALTER COLUMN [cfg_pct_category_supplier_discount]  decimal(19,2) NOT NULL;
ALTER TABLE [sdi_sdi_pricing_order_supplier] ALTER COLUMN [cfg_fixed_fee_ti]  decimal(19,2) NOT NULL;
ALTER TABLE [sdi_sdi_pricing_order_supplier] ALTER COLUMN [cal_fee_ti]  decimal(19,2) NOT NULL;
ALTER TABLE [sdi_sdi_pricing_order] ALTER COLUMN [cfg_vat]  decimal(19,2) NOT NULL;
ALTER TABLE [sdi_sdi_pricing_order] ALTER COLUMN [cfg_overall_default_fee]  decimal(19,2) NOT NULL;
ALTER TABLE [sdi_sdi_pricing_order] ALTER COLUMN [cal_fee_ti]  decimal(19,2) NOT NULL;
ALTER TABLE [sdi_sdi_organism_category_pricing_rebate] ALTER COLUMN [rebate]  decimal(19,2) NULL;
ALTER TABLE [sdi_sdi_pricing_profile] ADD CONSTRAINT DF_pp_state DEFAULT 1 FOR [state];
ALTER TABLE [sdi_sdi_pricing_profile] ADD CONSTRAINT DF_pp_checkedout  DEFAULT '0'  FOR [checked_out];
ALTER TABLE [sdi_sdi_pricing_profile] ADD CONSTRAINT DF_pp_checkedouttime DEFAULT '1900-01-01T00:00:00.000' FOR [checked_out_time];
...
ALTER TABLE  [#__sdi_order] DROP CONSTRAINT DF__sdi_sdi_o__valid__2F650636;
