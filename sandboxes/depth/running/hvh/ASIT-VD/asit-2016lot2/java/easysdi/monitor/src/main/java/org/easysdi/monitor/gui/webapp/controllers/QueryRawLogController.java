...
public class QueryRawLogController extends AbstractMonitorController {
     ...
     * <p>
     * The date is passed through the
     * <code>maxDate</code> request parameter. It must be formatted as
     * YYYY-MM-DD.
     * <p>
     * <i><b>Note:</b> The given date is <b>included</b> in the deletion span.
     * </i>
     *
     * @param request the request that asked for the logs' deletion
     * @param response the response to the request
     * @param jobIdString the string that identifies the parent job. It can
     * contain its identifier or its name
     * @param queryIdString the string that identifies the parent query. It can
     * contain its identifier or its name
     * @return an object containing a success message and which view must be
     * used to display it
     * @throws MonitorInterfaceException <ul>
     * <li>the query doesn't exist</li>
     * <li>the parent job isn't public and the user has insufficient rights to
     ...
     * <p>
     * Request parameters can be used to refine which log entries are fetched.
     * See {@link
     * LogSearchParams#createFromRequest(HttpServletRequest)} for more
     * information.
     *
     * @param request the request that asked for the raw logs
     * @param response the response to the request
     * @param jobIdString the string that identifies the parent job. It can
     * contain its identifier or its name
     * @param queryIdString the string that identifies the parent query. It can
     * contain its identifier or its name
     * @return an object containing the raw log entries and which view must be
    ...
    public ModelAndView show(HttpServletRequest request,
        ...
        result.addObject("noPagingCount",logManager.getRawLogsItemsNumber(searchParams.getMinDate(),searchParams.getMaxDate(),null, null));
