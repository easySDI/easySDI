...
/**
 * search_criteria Table class
 */
class Easysdi_catalogTablesearch_criteria extends sdiTable {
    ...
    public function bind($array, $ignore = '') {
		...
		if(($task == 'save' || $task == 'apply') && (!JFactory::getUser()->authorise('core.edit.state','com_easysdi_catalog.search_criteria.'.$array['id']) && $array['state'] == 1)){
			$array['state'] = 0;
		}

        if(!JFactory::getUser()->authorise('core.admin', 'com_easysdi_catalog.search_criteria.'.$array['id'])){
            $actions = JFactory::getACL()->getActions('com_easysdi_catalog','search_criteria');
            $default_actions = JFactory::getACL()->getAssetRules('com_easysdi_catalog.search_criteria.'.$array['id'])->getData();
            $array_jaccess = array();
    ...
    */
    protected function _getAssetName() {
        $k = $this->_tbl_key;
        return 'com_easysdi_catalog.search_criteria.' . (int) $this->$k;
    }
