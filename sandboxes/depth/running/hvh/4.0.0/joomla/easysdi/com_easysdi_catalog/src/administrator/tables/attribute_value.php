...
/**
 * attribute_value Table class
 */
class Easysdi_catalogTableattribute_value extends sdiTable {
    ...
    public function bind($array, $ignore = '') {
		...
		if(($task == 'save' || $task == 'apply') && (!JFactory::getUser()->authorise('core.edit.state','com_easysdi_catalog.attribute_value.'.$array['id']) && $array['state'] == 1)){
			$array['state'] = 0;
		}
        ...
        if(!JFactory::getUser()->authorise('core.admin', 'com_easysdi_catalog.attribute_value.'.$array['id'])){
            $actions = JFactory::getACL()->getActions('com_easysdi_catalog','attribute_value');
            $default_actions = JFactory::getACL()->getAssetRules('com_easysdi_catalog.attribute_value.'.$array['id'])->getData();
            $array_jaccess = array();
    ...
    */
    protected function _getAssetName() {
        $k = $this->_tbl_key;
        return 'com_easysdi_catalog.attribute_value.' . (int) $this->$k;
    }
