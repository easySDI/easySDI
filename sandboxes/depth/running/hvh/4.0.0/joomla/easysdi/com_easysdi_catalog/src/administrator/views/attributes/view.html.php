 ...
 */
class Easysdi_catalogViewAttributes extends JViewLegacy
{
	protected $items;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_EASYSDI_CATALOG_TITLE_ATTRIBUTES'), 'attributes.png');

        //Check if the form exists before showing the add/edit buttons
        $formPath = JPATH_COMPONENT_ADMINISTRATOR.'/views/attribute';
		...
		JHtmlSidebar::setAction('index.php?option=com_easysdi_catalog&view=attributes');
	...
	protected function getSortFields()
	{
		...
		'a.created_by' => JText::_('COM_EASYSDI_CATALOG_ATTRIBUTES_CREATED_BY'),
		'a.modified_by' => JText::_('COM_EASYSDI_CATALOG_ATTRIBUTES_MODIFIED_BY'),
		'a.ordering' => JText::_('JGRID_HEADING_ORDERING'),
		'a.state' => JText::_('JSTATUS'),
		'a.checked_out' => JText::_('COM_EASYSDI_CATALOG_ATTRIBUTES_CHECKED_OUT'),
		'a.checked_out_time' => JText::_('COM_EASYSDI_CATALOG_ATTRIBUTES_CHECKED_OUT_TIME'),
		'a.name' => JText::_('COM_EASYSDI_CATALOG_ATTRIBUTES_NAME'),
		);
	}
