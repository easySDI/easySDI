 ...
 */
class Easysdi_catalogViewRelations extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		Easysdi_catalogHelper::addSubmenu('relations');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_EASYSDI_CATALOG_TITLE_RELATIONS'), 'relations.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_easysdi_catalog&view=relations');
	...
	protected function getSortFields()
	{
		...
		'a.created_by' => JText::_('COM_EASYSDI_CATALOG_RELATIONS_CREATED_BY'),
		'a.modified_by' => JText::_('COM_EASYSDI_CATALOG_RELATIONS_MODIFIED_BY'),
		'a.ordering' => JText::_('JGRID_HEADING_ORDERING'),
		'a.state' => JText::_('JSTATUS'),
		'a.checked_out' => JText::_('COM_EASYSDI_CATALOG_RELATIONS_CHECKED_OUT'),
		'a.checked_out_time' => JText::_('COM_EASYSDI_CATALOG_RELATIONS_CHECKED_OUT_TIME'),
		'a.name' => JText::_('COM_EASYSDI_CATALOG_RELATIONS_NAME'),
		);
	}
