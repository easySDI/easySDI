 ...
 */
class Easysdi_catalogViewProfiles extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		Easysdi_catalogHelper::addSubmenu('profiles');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_EASYSDI_CATALOG_TITLE_PROFILES'), 'profiles.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_easysdi_catalog&view=profiles');
	...
	protected function getSortFields()
	{
		...
		'a.created_by' => JText::_('COM_EASYSDI_CATALOG_PROFILES_CREATED_BY'),
		'a.modified_by' => JText::_('COM_EASYSDI_CATALOG_PROFILES_MODIFIED_BY'),
		'a.ordering' => JText::_('JGRID_HEADING_ORDERING'),
		'a.state' => JText::_('JSTATUS'),
		'a.checked_out' => JText::_('COM_EASYSDI_CATALOG_PROFILES_CHECKED_OUT'),
		'a.checked_out_time' => JText::_('COM_EASYSDI_CATALOG_PROFILES_CHECKED_OUT_TIME'),
		'a.name' => JText::_('COM_EASYSDI_CATALOG_PROFILES_NAME'),
		);
	}
