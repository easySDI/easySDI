...
<script type="text/javascript">
    ...
    {
        if(task == 'search_criteria.cancel'){
            Joomla.submitform(task, document.getElementById('search_criteria-form'));
        }
        else{
            
            if (task != 'search_criteria.cancel' && document.formvalidator.isValid(document.id('search_criteria-form'))) {
