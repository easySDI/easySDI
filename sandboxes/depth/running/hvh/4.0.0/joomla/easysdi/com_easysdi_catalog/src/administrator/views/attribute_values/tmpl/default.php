...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_easysdi_catalog&task=attribute_values.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'attribute_valueList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
...
<form action="<?php echo JRoute::_('index.php?option=com_easysdi_catalog&view=attribute_values'); ?>" method="post" name="adminForm" id="adminForm">
...
<?php endif;?>
		...
		<table class="table table-striped" id="attribute_valueList">
			<thead>
				<tr>
			...
			<?php foreach ($this->items as $i => $item) :
                ...
                <?php if (isset($this->items[0]->state)): ?>
					<td class="center">
						<?php echo JHtml::_('jgrid.published', $item->state, $i, 'attribute_values.', $canChange, 'cb'); ?>
					</td>
                <?php endif; ?>
