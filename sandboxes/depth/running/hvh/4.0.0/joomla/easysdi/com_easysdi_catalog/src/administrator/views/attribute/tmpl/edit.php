...
<form action="<?php echo JRoute::_('index.php?option=com_easysdi_catalog&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="attribute-form" class="form-validate">
    <div class="row-fluid">
        <div class="span10 form-horizontal">
			...
			<div class="control-group">
				<div class="control-label"><?php echo $this->form->getLabel('attributetype_id'); ?></div>
				<div class="controls"><?php echo $this->form->getInput('attributetype_id'); ?></div>
			</div>
			<div class="control-group">
			...
			<div class="control-group">
				<div class="control-label"><?php echo $this->form->getLabel('listnamespace_id'); ?></div>
				<div class="controls"><?php echo $this->form->getInput('listnamespace_id'); ?></div>
			</div>
			<div class="control-group">
				<div class="control-label"><?php echo $this->form->getLabel('type_isocode'); ?></div>
				<div class="controls"><?php echo $this->form->getInput('type_isocode'); ?></div>
			</div>
			<div class="control-group">
