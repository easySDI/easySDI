...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_easysdi_catalog&task=profiles.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_easysdi_catalog&view=profiles'); ?>" method="post" name="adminForm" id="adminForm">
...
<?php endif;?>
		...
		<table class="table table-striped" id="profileList">
			<thead>
				...
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_EASYSDI_CATALOG_PROFILES_CREATED_BY', 'a.created_by', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_EASYSDI_CATALOG_PROFILES_MODIFIED_BY', 'a.modified_by', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_EASYSDI_CATALOG_PROFILES_NAME', 'a.name', $listDirn, $listOrder); ?>
				</th>
