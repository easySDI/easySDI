...
<script type="text/javascript">
    ...
    getScript('//ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js',function() {
        ...
        js(document).ready(function(){
            js('#form-property').submit(function(event){
...
<div class="property-edit front-end-edit">
    ...
    <form id="form-property" action="<?php echo JRoute::_('index.php?option=com_easysdi_shop&task=property.save'); ?>" method="post" class="form-validate" enctype="multipart/form-data">
        <ul>
			...
			<div class="control-group">
				<?php $canState = false; ?>
				<?php if($this->item->id): ?>
					<?php $canState = $canState = JFactory::getUser()->authorise('core.edit.state','com_easysdi_shop.property'); ?>
				<?php else: ?>
					<?php $canState = JFactory::getUser()->authorise('core.edit.state','com_easysdi_shop.property.'.$this->item->id); ?>
			...
			<div class="control-group">
				<div class="control-label"><?php echo $this->form->getLabel('propertytype_id'); ?></div>
				<div class="controls"><?php echo $this->form->getInput('propertytype_id'); ?></div>
			</div>
			<div class="control-group">
			...
			<div class="control-group">
                ...
                <script type="text/javascript">
                    ...
                    jQuery('.tab-pane select').each(function(){
                       ...
                       document.getElementById("form-property").appendChild(input);
        ...
        <div>
            ...
            <?php echo JText::_('or'); ?>
            <a href="<?php echo JRoute::_('index.php?option=com_easysdi_shop&task=property.cancel'); ?>" title="<?php echo JText::_('JCANCEL'); ?>"><?php echo JText::_('JCANCEL'); ?></a>
