 ...
 */
class Easysdi_shopModeldiffusionnotifiedusers extends JModelList {
    ...
    protected function getListQuery() {
        ...
        $query->from('`#__sdi_diffusion_notifieduser` AS a');

        
		// Join over the foreign key 'diffusion_id'
		$query->select('#__sdi_diffusion_650637.name AS diffusions_name_650637');
		$query->join('LEFT', '#__sdi_diffusion AS #__sdi_diffusion_650637 ON #__sdi_diffusion_650637.id = a.diffusion_id');
