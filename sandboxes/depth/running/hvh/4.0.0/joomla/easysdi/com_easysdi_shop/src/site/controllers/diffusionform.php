 ...
 */
class Easysdi_shopControllerDiffusionForm extends Easysdi_shopController
{
	...
	public function edit()
	{
		...
		// Get the model.
		$model = $this->getModel('DiffusionForm', 'Easysdi_shopModel');
	...
	public function save()
	{
		...
		if ($data === false) {
			...
			$this->setRedirect(JRoute::_('index.php?option=com_easysdi_shop&view=diffusionform&layout=edit&id='.$id, false));
			return false;
		}
