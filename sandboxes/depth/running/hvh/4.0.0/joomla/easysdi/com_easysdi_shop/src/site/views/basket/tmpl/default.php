...
<?php if ($this->item && $this->item->extractions) : ?>
    ...
    <?php echo $this->getToolbar(); ?>
                            ...
                            <div class="row-fluid">
                                <div class="span4">
                                    <div class="btn-group" id="btns-selection" data-toggle="buttons-radio">
                                        <a href="#" id="btn-selection" class="btn"  data-toggle="button" onClick="toggleSelectControl('selection');
            return false;"><i class="icon-pencil-2"></i></a>
                                        <a href="#" id="btn-pan" class="btn active"  data-toggle="button" onClick="toggleSelectControl('pan');
        ...
        elseif ($perimeter->id == 2):
            ...
            <?php if ($this->item->isrestrictedbyperimeter):
                ?>var userperimeter = '<?php echo addslashes($this->user->perimeter); ?>';
            <?php endif;
            ?>
                                                        function selectPerimeter<?php echo $perimeter->id; ?>() {
    ...
    <?php if (!empty($this->item->extent)): ?>
        ...
        <input type="hidden" name="perimeter" id="perimeter" value="<?php if (!empty($this->item->extent)): echo $this->item->extent->id;
               endif;
               ?>" />
        <input type="hidden" name="perimetern" id="perimetern" value="<?php if (!empty($this->item->extent)): echo $this->item->extent->name;
           endif;
           ?>" />
        <input type="hidden" name="surface" id="surface" value="<?php if (!empty($this->item->extent->surface)): echo $this->item->extent->surface;
           endif;
           ?>" />
        <input type="hidden" name="allowedbuffer" id="allowedbuffer" value="" />
        <input type="hidden" name="features" id="features" value='<?php if (!empty($this->item->extent)): echo json_encode($this->item->extent->features);
           endif;
           ?>' />
        <input type="hidden" name="t-perimeter" id="t-perimeter" value="<?php if (!empty($this->item->extent)): echo $this->item->extent->id;
           endif;
           ?>" />
        <input type="hidden" name="t-perimetern" id="t-perimetern" value="<?php if (!empty($this->item->extent)): echo $this->item->extent->name;
           endif;
               ?>" />
        <input type="hidden" name="t-features" id="t-features" value='<?php if (!empty($this->item->extent)): echo json_encode($this->item->extent->features);
    endif;
               ?>' />
        <input type="hidden" name="t-surface" id="t-surface" value="<?php if (!empty($this->item->extent)): echo $this->item->extent->surface;
    endif;
    ?>" />
