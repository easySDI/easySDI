 ...
 */
class Easysdi_shopControllerOrderForm extends Easysdi_shopController
{
	...
	public function edit()
	{
		...
		// Get the model.
		$model = $this->getModel('OrderForm', 'Easysdi_shopModel');
	...
	public function save()
	{
		...
		if ($data === false) {
			...
			$this->setRedirect(JRoute::_('index.php?option=com_easysdi_shop&view=orderform&layout=edit&id='.$id, false));
			return false;
		}
