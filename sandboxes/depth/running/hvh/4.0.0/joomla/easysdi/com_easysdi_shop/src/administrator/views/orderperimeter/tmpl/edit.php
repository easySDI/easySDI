...
<script type="text/javascript">
    ...
    {
        if(task == 'orderperimeter.cancel'){
            Joomla.submitform(task, document.getElementById('orderperimeter-form'));
        }
        else{
            
            if (task != 'orderperimeter.cancel' && document.formvalidator.isValid(document.id('orderperimeter-form'))) {
...
<form action="<?php echo JRoute::_('index.php?option=com_easysdi_shop&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="orderperimeter-form" class="form-validate">
    <div class="row-fluid">
