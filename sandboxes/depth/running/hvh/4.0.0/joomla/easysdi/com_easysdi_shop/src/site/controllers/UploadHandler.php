...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        $this->options = array(
            'script_url' => 'http://localhost/sdi4/indexp.php?option=com_easysdi_shop&task=diffusion.upload'.'/',
            'upload_dir' => 'C:\www\sdi4\tmp'.'/files/',
            'upload_url' => 'localhost/sdi4/tmp'.'/files/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
