...
//         SqueezeBox.loadModal('http://localhost/sdi4a8/index.php/catalog-main&tmpl=component','iframe',650,400);
//    document.getElementById('sdi-catalog-iframe').setAttribute('src', 'http://localhost/sdi4a8/index.php/catalog-main&tmpl=component');
//    document.getElementById('sbox-window').style.display = 'visible';
//    var ifrm = document.createElement('iframe');
//    ifrm.src = 'http://localhost/sdi4a8/index.php/catalog-main&tmpl=component';
    
//    window.open('http://localhost/sdi4a8/index.php/catalog-main', 'theFrame');
//    var ifrm = document.createElement('iframe');
//	ifrm.style.width = '460px';
//	ifrm.style.height = '80px';
//	ifrm.src = 'http://localhost/sdi4a8/index.php/catalog-main';
//	ifrm.frameBorder = 0;
//	ifrm.scrolling = "no";
...
//    bodyCfg : {
//       tag : "iframe",
//       src : "http://localhost/sdi4a8/index.php/catalog-main"
//    }
//}).show();
}
