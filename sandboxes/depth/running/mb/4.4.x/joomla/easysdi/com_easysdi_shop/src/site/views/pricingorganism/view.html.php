 ...
 * View to edit
 */
class Easysdi_shopViewPricingOrganism extends JViewLegacy {
    ...
    public function display($tpl = null) {
        ...
        $this->isPricingManager = $this->user->isPricingManager($this->item->id);
        ...
        if(!$this->isPricingManager && !$this->user->isOrganismManager($this->item->id)){
            JFactory::getApplication()->enqueueMessage(JText::_('JERROR_ALERTNOAUTHOR'), 'error');
