...
?>
<div class="module-title nav-header"><i class="icon-download" style="text-transform: none;"></i> <?php echo JText::_('COM_EASYSDI_DASHBOARD_SHOP_IND_TOPDOWNLOADS_TITLE'); ?></div> 
<div id="<?php echo('div_'.$indicator_name); ?>">
    <table class="table table-bordered table-striped table-condensed result-success">
        <thead>
            <tr>
                <th><?php echo JText::_('COM_EASYSDI_DASHBOARD_SHOP_IND_TOPDOWNLOADS_COL1'); ?></th>
                <th><?php echo JText::_('COM_EASYSDI_DASHBOARD_SHOP_IND_TOPDOWNLOADS_COL2'); ?></th>
            </tr>
        </thead>
        <tbody>
