 ...
 * Easysdi_map model.
 */
class Easysdi_mapModelLayerForm extends JModelForm
{
	...
	protected function populateState()
	{
        ...
        if (JFactory::getApplication()->input->get('layout') == 'edit') {
            $id = JFactory::getApplication()->getUserState('com_easysdi_map.edit.layer.id');
        } else {
            $id = JFactory::getApplication()->input->get('id');
            JFactory::getApplication()->setUserState('com_easysdi_map.edit.layer.id', $id);
        }
		$this->setState('layer.id', $id);
	...
	{
		// Get the id.
		$id = (!empty($id)) ? $id : (int)$this->getState('layer.id');
	...
	{
		// Get the form.
		$form = $this->loadForm('com_easysdi_map.layer', 'layerform', array('control' => 'jform', 'load_data' => $loadData));
		if (empty($form)) {
			return false;
		}
