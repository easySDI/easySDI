...
ALTER TABLE `#__sdi_sys_rendertype_attributetype`
ADD CONSTRAINT `#__sdi_sys_rendertype_attributetype_fk1` FOREIGN KEY (`attributetype_id`) REFERENCES `#__sdi_sys_attributetype` (`id`);

ALTER TABLE `#__sdi_sys_rendertype_attributetype`
ADD CONSTRAINT `#__sdi_sys_rendertype_attributetype_fk2` FOREIGN KEY (`rendertype_id`) REFERENCES `#__sdi_sys_rendertype` (`id`);
