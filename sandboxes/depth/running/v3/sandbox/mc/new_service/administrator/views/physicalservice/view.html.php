...
class Easysdi_serviceViewPhysicalservice extends JViewLegacy
{
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_EASYSDI_SERVICE_TITLE_PHYSICALSERVICE'), 'physicalservice.png');
		...
		if (!$isNew && $canDo->get('core.create')) {
			JToolBarHelper::custom('physicalservice.save2copy', 'save-copy.png', 'save-copy_f2.png', 'JTOOLBAR_SAVE_AS_COPY', false);
		}
