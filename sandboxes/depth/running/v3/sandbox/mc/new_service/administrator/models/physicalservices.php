...
class Easysdi_serviceModelphysicalservices extends JModelList
{
    ...
    public function __construct($config = array())
    {
        if (empty($config['filter_fields'])) {
            $config['filter_fields'] = array(
                ...
                'negociatedversion', 'a.negociatedversion',
                'resourceurl', 'a.resourceurl',
                'resourceauthentication', 'a.resourceauthentication',
                'resourceusername', 'a.resourceusername',
                'resourcepassword', 'a.resourcepassword',
                'serviceauthentication', 'a.serviceauthentication',
    ...
    $query->join('LEFT', '#__users AS uc ON uc.id=a.checked_out');
		...
		$query->select('#__sdi_virtualservice_261210.name AS virtualservices_name_261210');
		$query->join('LEFT', '#__sdi_virtualservice AS #__sdi_virtualservice_261210 ON #__sdi_virtualservice_261210.id = a.virtualservice_id');
