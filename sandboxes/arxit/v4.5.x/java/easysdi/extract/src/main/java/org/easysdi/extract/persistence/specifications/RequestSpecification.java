 ...
 */
package org.easysdi.extract.persistence.specifications;
...
import org.easysdi.extract.domain.Request_;
...
public final class RequestSpecification {
     ...
     */
    public static Specification<Request> isBoundToProcess(final org.easysdi.extract.domain.Process process) {
    ...
    public static Specification<Request> isProcessInList(
            final Collection<org.easysdi.extract.domain.Process> processesList
    ) {
    ...
    public static Specification<Request> isFinished() {
        ...
        return new Specification<Request>() {
            ...
            public Predicate toPredicate(final Root<Request> root, final CriteriaQuery<?> query,
                    final CriteriaBuilder builder) {
                return builder.equal(root.get(Request_.status), Status.FINISHED);
            }
