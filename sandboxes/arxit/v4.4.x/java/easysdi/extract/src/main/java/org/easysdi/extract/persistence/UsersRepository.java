...
public interface UsersRepository extends PagingAndSortingRepository<User, Integer> {
    ...
    /**
     * Obtains the user from her identifier.
     *
     * @param id the number that uniquely identifies the user in the application
     * @return the user, or <code>null</code> if none matches the given identifier
     */
