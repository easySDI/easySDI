...
function displayMapTypeOptions() {
    if (jQuery("input[name='jform[type]']:checked").val() == 'leaflet') {
        ...
        jQuery("#jform_tool22-lbl").parent().parent().show();
        jQuery("#jform_tool23-lbl").parent().parent().show();
        jQuery("#jform_tool24-lbl").parent().parent().show();
        ...
        jQuery("#jform_tool22-lbl").parent().parent().hide();
        jQuery("#jform_tool23-lbl").parent().parent().hide();
        jQuery("#jform_tool24-lbl").parent().parent().hide();
        jQuery("#scaletab").show();
        jQuery("#wfstab").show();
