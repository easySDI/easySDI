...
public class RequestsController extends BaseController {
    ...
    public final String viewItem(@PathVariable final int itemId, final ModelMap model,
        ...
        final Request request = this.requestsRepository.findOne(itemId);
    ...
    public final String viewList(final ModelMap model, final RedirectAttributes redirectAttributes) {
        ...
        return RequestsController.REDIRECT_TO_HOME;
    }
    ...
    private boolean canCurrentUserViewRequestDetails(final Request request) {
        ...
        final org.easysdi.extract.domain.Process process = request.getProcess();
     ...
     */
    @Transactional
    private void relaunchProcess(final Request request) {
     ...
     */
    @Transactional
    private void restartCurrentTask(final Request request
    ) {
        assert request != null : "The request cannot be null.";
     ...
     */
    @Transactional
    private void restartExport(final Request request
    ) {
     ...
     */
    @Transactional
    private void restartMatching(final Request request
    ) {
        assert this.isCurrentUserAdmin() : "The current user must be an administrator.";
        assert request != null : "The request cannot be null.";
     ...
     */
    @Transactional
    private void validateRequest(final Request request, final String remark) {
        assert request != null : "The request must not be null";
