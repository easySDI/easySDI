  ...
  function uploadScript()
  {
	...
	*/
	...
	if ($error) {
		...
		move_uploaded_file($_FILES['Filedata']['tmp_name'], JPATH_COMPONENT_ADMINISTRATOR.DS.'uploads'.DS.$_FILES['Filedata']['name']);
		$return['src'] = JPATH_COMPONENT_ADMINISTRATOR.DS.'uploads'.DS. $_FILES['Filedata']['name'];
