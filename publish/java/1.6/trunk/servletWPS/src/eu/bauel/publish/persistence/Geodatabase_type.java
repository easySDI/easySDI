...
public class Geodatabase_type extends JTable {
	...
	public static int getId(String name)
	{
		...
		try {
			...
			ResultSet rs;
			rs = statement.executeQuery("SELECT id FROM geodatabase_type where name='"+name+"'");
			rs.next();
			return rs.getInt("id");
