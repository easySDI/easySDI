...
class TOOLBAR_accountprofile {
	function _DEFAULT() {
		JToolBarHelper::title(JText::_("CORE_LIST_ACCOUNTPROFILE"));
		
		JToolBarHelper::addNew('newAccountProfile');
		JToolBarHelper::editList('editAccountProfile');
		JToolBarHelper::deleteList('','removeAccountProfile');
	...
	function _EDIT() {
		...
		JToolBarHelper::title(JText::_( 'CORE_EDIT_ACCOUNTPROFILE' ).': <small><small>[ '. $text.' ]</small></small>', 'addedit.png');
