...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
							...
							<fo:block>
									...
									<xsl:if test="billing/lastname != ''">
										<fo:block text-align="start" line-height="12pt" font-family="arial" font-size="10pt">
											<xsl:choose>
												...
												<xsl:when test="billing/title = '4'"><xsl:text>Maître </xsl:text></xsl:when>
												<xsl:when test="billing/title = '5'"><xsl:text>Madame la Présidente </xsl:text></xsl:when>
												<xsl:when test="billing/title = '6'"><xsl:text>Monsieur le Président </xsl:text></xsl:when>
								...
								<fo:block-container height="70mm" width="170mm" top="100mm" left="20mm" position="absolute" border="1pt" border-style="solid" border-color="silver" padding-left="3pt" padding-right="3pt">
									<fo:block>
										...
										<!-- Affichage des montants définitifs -->
								...
								<fo:block-container height="30mm" width="50mm" top="259mm" left="3mm" position="absolute">
									<xsl:call-template name="address_member">
										...
										<xsl:with-param name="prénom" select="billing/firstname"/>
										...
										<xsl:with-param name="localité" select="billing/locality"/>
	...
	<xsl:template name="subscriberTemplate">
		...
		<fo:block text-align="left" line-height="12pt" font-family="arial" font-size="10pt">
			<xsl:text>- </xsl:text><xsl:value-of select="$subscriberElectricity"/><xsl:text> abonné(s) électricité à Frs. 0.18/ab.</xsl:text>
		</fo:block>
		<fo:block text-align="left" line-height="12pt" font-family="arial" font-size="10pt">
			<xsl:text>- </xsl:text><xsl:value-of select="$subscriberGaz"/><xsl:text> abonné(s) gaz à Frs. 0.18/ab.</xsl:text>
		</fo:block>
		<fo:block text-align="left" line-height="12pt" font-family="arial" font-size="10pt">
			<xsl:text>- </xsl:text><xsl:value-of select="$subscriberHeat"/><xsl:text> abonné(s) chauffage à distance à Frs. 0.18/ab.</xsl:text>
		</fo:block>
		<fo:block text-align="left" line-height="12pt" font-family="arial" font-size="10pt">
			<xsl:text>- </xsl:text><xsl:value-of select="$subscriberTV"/><xsl:text> abonné(s) téléréseau à Frs. 0.10/ab.</xsl:text>
		</fo:block>
		<fo:block text-align="left" line-height="12pt" font-family="arial" font-size="10pt">
			<xsl:text>- </xsl:text><xsl:value-of select="$subscriberOther"/><xsl:text> abonné(s) autre à Frs. 0.18/ab.</xsl:text>
		</fo:block>
	</xsl:template>
	...
	<xsl:template name="employeeTemplate">
		...
		<fo:block text-align="left" line-height="12pt" font-family="arial" font-size="10pt">
			<xsl:choose>
				...
				<!-- quantité d'employés inconnue -->
				<xsl:otherwise>
					<xsl:text>- quantité d'employés inconnue</xsl:text>
				</xsl:otherwise>
			</xsl:choose>
		</fo:block>
	</xsl:template>
	...
	<xsl:template name="memberTemplate">
		...
		<fo:block text-align="left" line-height="12pt" font-family="arial" font-size="10pt">
			<xsl:choose>
				...
				<!-- quantité de membres inconnue -->
				<xsl:otherwise>
					<xsl:text>- quantité de membres inconnue</xsl:text>
				</xsl:otherwise>
			</xsl:choose>
		</fo:block>
	</xsl:template>
	...
	<xsl:template name="activityTemplate">
		...
		<fo:block text-align="left" line-height="12pt" font-family="arial" font-size="10pt">
			<xsl:choose>
				...
				<!-- activité SIG inconnue -->
				<xsl:otherwise>
					<xsl:text>- activité SIG inconnue</xsl:text>
				</xsl:otherwise>
			</xsl:choose>
		</fo:block>
	</xsl:template>
	...
	<xsl:template name="address_member">
		...
		<fo:block text-align="left" line-height="12pt" font-family="arial" font-size="10pt"><xsl:value-of select="$pays"/><xsl:text> - </xsl:text><xsl:value-of select="$zip"/><xsl:text> </xsl:text><xsl:value-of select="$localité"/>
		</fo:block> 
	</xsl:template>
