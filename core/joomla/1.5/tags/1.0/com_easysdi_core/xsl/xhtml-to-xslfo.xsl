...
&lt;!DOCTYPE fo:root [
    ...
    =============================================== -->
          ...
          <xsl:otherwise>
            <fo:simple-page-master master-name="first"
              ...
              margin-right="36pt" margin-left="36pt"
              margin-bottom="36pt" margin-top="20pt">
  ...
  <!-- ============================================
    ...
    =============================================== -->
        ...
        <fo:static-content flow-name="ra-right">
          <fo:block font-size="10pt" text-align-last="end">
	    <fo:leader leader-pattern="rule" leader-length.optimum="100%" rule-thickness="1px"/>
            <fo:table table-layout="fixed">
	...
	<fo:block font-size="10pt" text-align-last="end">
	  ...
	  <fo:table table-layout="fixed">
		  ...
		  <fo:table-cell>
                    <fo:block text-align="start" font-style="italic">
                      GEOCatalogue vaudois - www.asitvd.ch
                    </fo:block>
                  </fo:table-cell>
		  <fo:table-cell>
                    <fo:block text-align="end">Page
  ...
  <xsl:template match="h3">
    <fo:block font-size="15pt" margin-top="10px" padding-left="5px" background-color="#E4E4E4" font-weight="bold" line-height="20pt"
  ...
  <xsl:template match="h4">
    <fo:block font-size="12pt" line-height="18pt"
      keep-with-next="always" text-decoration="underline" padding-left="5px" font-weight="bold" space-before="6pt" space-after="4pt">
      <xsl:attribute name="id">
        <xsl:choose>
          <xsl:when test="@id">
            <xsl:value-of select="@id"/>
  ...
  <xsl:template match="table">
    <fo:table table-layout="fixed"> 
      <xsl:if test="@id='metadataTitle'">
        <xsl:attribute name="background-color">
          <xsl:text>#A8D092</xsl:text>
        </xsl:attribute>
  ...
  <xsl:template match="td">
    <fo:table-cell 
      ...
      <xsl:if test="@class='furnisherTitle'">
  ...
  <xsl:template match="title">
    <fo:block space-after="2pt" padding-left="3px" padding-top="5px" border-left="5px" color="#FFFFFF" background-color="#5BAD27" line-height="22pt" 
