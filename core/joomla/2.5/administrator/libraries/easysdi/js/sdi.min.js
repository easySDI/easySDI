...
vector.addFeatures(clonedFeatures,{silent:true});this.layers.push(vector);}else{var l=layer.clone();l.setVisibility(layer.getVisibility());this.layers.push(l);}}},this);this.extent=this.sourceMap.getExtent();GeoExt.PrintMapPanel.superclass.initComponent.call(this);}});GeoExt.Lang.add("fr",{"sdi.gxp.plugins.Print.prototype":{buttonText:"Imprimer",menuText:"Imprimer la carte",tooltip:"Imprimer la carte",previewText:"Aperçu avant impression",notAllNotPrintableText:"Aucune couche ne peut être imprimée.",nonePrintableText:"Aucune des couches sélectionnées ne peut être imprimée pour des raisons de copyright."}});