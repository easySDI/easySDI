...
/**
  * Ext.ux.ExtendedRadio Extension Class
  *
  * @author  Stephanie Dondainaz
  * @version 1.0
  *
  * @class Ext.ux.ExtendedRadio
  * @extends Ext.form.Radio
  * @constructor
  * @param {Object} config Configuration options
  */
Ext.ux.ExtendedRadio = function(config) {
 
    // call parent constructor
    Ext.ux.ExtendedRadio.superclass.constructor.call(this, config);

} // end of Ext.ux.ExtendedFieldSet constructor
 
// extend
Ext.extend(Ext.ux.ExtendedRadio, Ext.form.Radio, {
    setValue: function(value) {
        Ext.ux.ExtendedRadio.superclass.setValue.call(this, value);
    },
    dynamic : false,		
