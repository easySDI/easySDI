...
/**
  * Ext.ux.ExtendedDateField Extension Class
  *
  * @author  Stephanie Dondainaz
  * @version 1.0
  *
  * @class Ext.ux.ExtendedDateField
  * @extends Ext.form.DateField
  * @constructor
  * @param {Object} config Configuration options
  */
Ext.ux.ExtendedDateField = function(config) {
 
    // call parent constructor
    Ext.ux.ExtendedDateField.superclass.constructor.call(this, config);

} // end of Ext.ux.ExtendedFieldSet constructor
 
// extend
Ext.extend(Ext.ux.ExtendedDateField, Ext.form.DateField, {
    setValue: function(value) {
        Ext.ux.ExtendedDateField.superclass.setValue.call(this, value);
    },
    dynamic : false,		
