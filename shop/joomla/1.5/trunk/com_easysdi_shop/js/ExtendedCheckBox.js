...
/**
  * Ext.ux.ExtendedCheckBox Extension Class
  *
  * @author  Stephanie Dondainaz
  * @version 1.0
  *
  * @class Ext.ux.ExtendedCheckBox
  * @extends Ext.form.Checkbox
  * @constructor
  * @param {Object} config Configuration options
  */
Ext.ux.ExtendedCheckBox = function(config) {
 
    // call parent constructor
    Ext.ux.ExtendedCheckBox.superclass.constructor.call(this, config);

} // end of Ext.ux.ExtendedFieldSet constructor
 
// extend
Ext.extend(Ext.ux.ExtendedCheckBox, Ext.form.Checkbox, {
    setValue: function(value) {
        Ext.ux.ExtendedCheckBox.superclass.setValue.call(this, value);
    },
    dynamic : false,
