...
/**
  * Ext.ux.ExtendedFormPanel Extension Class
  *
  * @author  Stephanie Dondainaz
  * @version 1.0
  *
  * @class Ext.ux.ExtendedFormPanel
  * @extends Ext.form.FormPanel
  * @constructor
  * @param {Object} config Configuration options
  */
Ext.ux.ExtendedFormPanel = function(config) {
 
    // call parent constructor
    Ext.ux.ExtendedFormPanel.superclass.constructor.call(this, config);
    this.el.dom.action = this.action;
    this.el.dom.target = this.target;
    this.el.dom.method = this.method;

} // end of Ext.ux.ExtendedFormPanel constructor
 
// extend
Ext.extend(Ext.ux.ExtendedFormPanel, Ext.form.FormPanel, {
    setValue: function(value) {
        Ext.ux.ExtendedFormPanel.superclass.setValue.call(this, value);
    },
    /**
