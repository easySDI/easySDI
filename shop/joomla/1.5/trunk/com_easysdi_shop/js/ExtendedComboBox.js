...
/**
  * Ext.ux.ExtendedComboBox Extension Class
  *
  * @author  Stephanie Dondainaz
  * @version 1.0
  *
  * @class Ext.ux.ExtendedComboBox
  * @extends Ext.form.ComboBox
  * @constructor
  * @param {Object} config Configuration options
  */
Ext.ux.ExtendedComboBox = function(config) {
 
    // call parent constructor
    Ext.ux.ExtendedComboBox.superclass.constructor.call(this, config);

} // end of Ext.ux.ExtendedFieldSet constructor
 
// extend
Ext.extend(Ext.ux.ExtendedComboBox, Ext.form.ComboBox, {
    setValue: function(value) {
        Ext.ux.ExtendedComboBox.superclass.setValue.call(this, value);
    },
    dynamic : false,		
