...
class ADMIN_product {
	...
	function saveProduct($returnList ,$option){
		 ...
		 * sdondainaz
		 * 
		 * Ajouter ici la mise � jour du param�tre de visibilit� pour la m�tadonn�e, avec CSW.
		 * Se baser sur le param�tre "externe" (boolean)
		 * "lors de la sauvegarde d'un produit, la valeur de la disponibilit� interne/externe est
		 * stock�e �galement dans la m�tadonn�e correspondante (geonetwork ne g�re pas les mises
		 * � jour et il est n�cessaire de charger la totalit� de la m�tadonn�e en m�moire, modifier
		 * l'attribut d�sir�, supprimer la m�tadonn�e actuelle dans GeoNetwork puis ins�rer la
		 * m�tadonn�e mise � jour en prenant soin de conserver le m�me identifiant)"
		 * 
		 */ 
