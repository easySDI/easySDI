...
public class UserValidator extends BaseValidator {
    ...
    public final void validate(final Object target, final Errors errors) {
        ...
        if (!validatingUser.isBeingCreated()) {
            User savedUser = this.usersRepository.findOne(validatingUser.getId());
            assert savedUser != null : "If the user is not being created, it should be present in the data source.";
