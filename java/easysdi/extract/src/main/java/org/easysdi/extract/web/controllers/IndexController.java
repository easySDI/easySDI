...
import org.easysdi.extract.persistence.sorts.RequestSort;
import org.easysdi.extract.persistence.specifications.RequestSpecification;
import org.easysdi.extract.web.Message.MessageType;
import org.easysdi.extract.web.model.RequestModel;
import org.easysdi.extract.web.model.comparators.RequestModelByTaskDateComparator;
import org.easysdi.extract.web.model.json.ConnectorJsonModel;
import org.easysdi.extract.web.model.json.DataTableResponse;
import org.easysdi.extract.web.model.json.PublicField;
import org.easysdi.extract.web.model.json.RequestJsonModel;
...
public class IndexController extends BaseController {
    ...
    public final String index(final HttpSession session, final RedirectAttributes redirectAttributes,
        ...
        if (!this.isCurrentUserApplicationUser()) {
            return IndexController.REDIRECT_TO_ACCESS_DENIED;
        }
    ...
    public final String handleForbidden(final RedirectAttributes redirectAttributes) {
        ...
        if (!this.isCurrentUserApplicationUser()) {
            return IndexController.REDIRECT_TO_LOGIN;
        }
        ...
        return IndexController.REDIRECT_TO_HOME;
    }
    ...
    private Page<Request> getFinishedRequests(final int pageStart, final String sortFields,
        ...
        return this.requestsRepository.findAll(where(userCriteria).and(searchCriteria), paging);
    }
     ...
     *         displayed
     */
    private org.easysdi.extract.domain.Process getProcessForFilter(final String processIdString) {
        ...
        return this.processesRepository.findOne(processId);
    }
