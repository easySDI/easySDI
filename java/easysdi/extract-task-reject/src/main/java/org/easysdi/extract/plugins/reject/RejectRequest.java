...
/**
 * The description of an ordered data item whose process includes being rejected.
 *
 * @author Yves Grasset
 */
public class RejectRequest implements ITaskProcessorRequest {
    ...
    /**
     * Creates a new instance of a request that requires an automated remark.
     */
    ...
    /**
     * Creates a new instance of a request that requires an automated remark based on an existing request.
     *
     * @param originalRequest the request to copy in this instance
     */
    public RejectRequest(final ITaskProcessorRequest originalRequest) {
        ...
        this.productLabel = originalRequest.getProductLabel();
        this.rejected = originalRequest.isRejected();
