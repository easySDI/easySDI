...
/**
 * The outcome of an FME Server process task.
 *
 * @author Florent Krin
 */
public class FmeServerResult implements ITaskProcessorResult {

    /**
     * The string that identifies the type of error that prevented the FME Server task from completing,
     * if any.
     */
    private String errorCode;

    /**
     * Additional information about the type of error that prevented the FME Server task from completing,
     * if any.
     */
    private String message;

    /**
     * The final state of the FME Server task.
     */
    ...
    /**
     * Defines the type of error that prevented this FME Server task from completing successfully.
     *
    ...
    /**
     * Defines additional information about the error that prevented this FME Server task from completing
     * successfully.
     *
    ...
    /**
     * Defines the final state of the FME Server task.
     *
    ...
    /**
     * Defines the data item request that required this FME Server task as part of its process.
     * <p>
     * <i>Note that some of its properties may have been updated by the task plugin.</i>
     * </p>
     *
     * @param requestToProcess the request that needed to be processed by FME Server
     */
