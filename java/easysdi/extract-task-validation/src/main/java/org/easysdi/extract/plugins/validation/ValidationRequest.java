...
/**
 * The description of an ordered data item whose process requires validation by an operator.
 *
 * @author Florent Krin
 */
public class ValidationRequest implements ITaskProcessorRequest {
